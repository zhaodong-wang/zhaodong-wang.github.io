...
`)}const $d={[Ro]:"Linear",[wo]:"Reinhard",[Co]:"Cineon",[Po]:"ACESFilmic",[Lo]:"AgX",[Uo]:"Neutral",[Do]:"Custom"};function jd(i,e){const t=$d[e];return t===void 0?(Re("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+i+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const lr=new F;function Jd(){He.getLuminanceCoefficients(lr);const i=lr.x.toFixed(4),e=lr.y.toFixed(4),t=lr.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
}`,Up=[new F(1,0,0),new F(-1,0,0),new F(0,1,0),new F(0,-1,0),new F(0,0,1),new F(0,0,-1)],Ip=[new F(0,-1,0),new F(0,-1,0),new F(0,0,1),new F(0,0,-1),new F(0,-1,0),new F(0,-1,0)],To=new it,Ai=new F,rs=new F;function Np(i,e,t){let n=new Ko;const r=new ke,s=new ke,a=new ft,o=new Kc,l=new Zc,c={},h=t.maxTextureSize,p={[Rn]:At,[At]:Rn,[un]:un},u=new nn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new ke},radius:{value:4}},vertexShader:Dp,fragmentShader:Lp}),m=u.clone();m.defines.HORIZONTAL_PASS=1;const v=new qt;v.setAttribute("position",new Wt(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const E=new Xt(v,u),d=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=cr;let f=this.type;this.render=function(y,C,g){if(d.enabled===!1||d.autoUpdate===!1&&d.needsUpdate===!1||y.length===0)return;this.type===Ml&&(Re("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=cr);const T=i.getRenderTarget(),U=i.getActiveCubeFace(),R=i.getActiveMipmapLevel(),N=i.state;N.setBlending(hn),N.buffers.depth.getReversed()===!0?N.buffers.color.setClear(0,0,0,0):N.buffers.color.setClear(1,1,1,1),N.buffers.depth.setTest(!0),N.setScissorTest(!1);const k=f!==this.type;k&&C.traverse(function(W){W.material&&(Array.isArray(W.material)?W.material.forEach(D=>D.needsUpdate=!0):W.material.needsUpdate=!0)});for(let W=0,D=y.length;W<D;W++){const z=y[W],H=z.shadow;if(H===void 0){Re("WebGLShadowMap:",z,"has no shadow.");continue}if(H.autoUpdate===!1&&H.needsUpdate===!1)continue;r.copy(H.mapSize);const j=H.getFrameExtents();r.multiply(j),s.copy(H.mapSize),(r.x>h||r.y>h)&&(r.x>h&&(s.x=Math.floor(h/j.x),r.x=s.x*j.x,H.mapSize.x=s.x),r.y>h&&(s.y=Math.floor(h/j.y),r.y=s.y*j.y,H.mapSize.y=s.y));const Q=i.state.buffers.depth.getReversed();if(H.camera._reversedDepth=Q,H.map===null||k===!0){if(H.map!==null&&(H.map.depthTexture!==null&&(H.map.depthTexture.dispose(),H.map.depthTexture=null),H.map.dispose()),this.type===Ri){if(z.isPointLight){Re("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}H.map=new en(r.x,r.y,{format:Vn,type:pn,minFilter:Et,magFilter:Et,generateMipmaps:!1}),H.map.texture.name=z.name+".shadowMap",H.map.depthTexture=new pi(r.x,r.y,Ht),H.map.depthTexture.name=z.name+".shadowMapDepth",H.map.depthTexture.format=mn,H.map.depthTexture.compareFunction=null,H.map.depthTexture.minFilter=xt,H.map.depthTexture.magFilter=xt}else z.isPointLight?(H.map=new il(r.x),H.map.depthTexture=new Hc(r.x,tn)):(H.map=new en(r.x,r.y),H.map.depthTexture=new pi(r.x,r.y,tn)),H.map.depthTexture.name=z.name+".shadowMap",H.map.depthTexture.format=mn,this.type===cr?(H.map.depthTexture.compareFunction=Q?la:oa,H.map.depthTexture.minFilter=Et,H.map.depthTexture.magFilter=Et):(H.map.depthTexture.compareFunction=null,H.map.depthTexture.minFilter=xt,H.map.depthTexture.magFilter=xt);H.camera.updateProjectionMatrix()}const le=H.map.isWebGLCubeRenderTarget?6:1;for(let ve=0;ve<le;ve++){if(H.map.isWebGLCubeRenderTarget)i.setRenderTarget(H.map,ve),i.clear();else{ve===0&&(i.setRenderTarget(H.map),i.clear());const pe=H.getViewport(ve);a.set(s.x*pe.x,s.y*pe.y,s.x*pe.z,s.y*pe.w),N.viewport(a)}if(z.isPointLight){const pe=H.camera,Ae=H.matrix,Fe=z.distance||pe.far;Fe!==pe.far&&(pe.far=Fe,pe.updateProjectionMatrix()),Ai.setFromMatrixPosition(z.matrixWorld),pe.position.copy(Ai),rs.copy(pe.position),rs.add(Up[ve]),pe.up.copy(Ip[ve]),pe.lookAt(rs),pe.updateMatrixWorld(),Ae.makeTranslation(-Ai.x,-Ai.y,-Ai.z),To.multiplyMatrices(pe.projectionMatrix,pe.matrixWorldInverse),H._frustum.setFromProjectionMatrix(To,pe.coordinateSystem,pe.reversedDepth)}else H.updateMatrices(z);n=H.getFrustum(),b(C,g,H.camera,z,this.type)}H.isPointLightShadow!==!0&&this.type===Ri&&S(H,g),H.needsUpdate=!1}f=this.type,d.needsUpdate=!1,i.setRenderTarget(T,U,R)};function S(y,C){const g=e.update(E);u.defines.VSM_SAMPLES!==y.blurSamples&&(u.defines.VSM_SAMPLES=y.blurSamples,m.defines.VSM_SAMPLES=y.blurSamples,u.needsUpdate=!0,m.needsUpdate=!0),y.mapPass===null&&(y.mapPass=new en(r.x,r.y,{format:Vn,type:pn})),u.uniforms.shadow_pass.value=y.map.depthTexture,u.uniforms.resolution.value=y.mapSize,u.uniforms.radius.value=y.radius,i.setRenderTarget(y.mapPass),i.clear(),i.renderBufferDirect(C,null,g,u,E,null),m.uniforms.shadow_pass.value=y.mapPass.texture,m.uniforms.resolution.value=y.mapSize,m.uniforms.radius.value=y.radius,i.setRenderTarget(y.map),i.clear(),i.renderBufferDirect(C,null,g,m,E,null)}function A(y,C,g,T){let U=null;const R=g.isPointLight===!0?y.customDistanceMaterial:y.customDepthMaterial;if(R!==void 0)U=R;else if(U=g.isPointLight===!0?l:o,i.localClippingEnabled&&C.clipShadows===!0&&Array.isArray(C.clippingPlanes)&&C.clippingPlanes.length!==0||C.displacementMap&&C.displacementScale!==0||C.alphaMap&&C.alphaTest>0||C.map&&C.alphaTest>0||C.alphaToCoverage===!0){const N=U.uuid,k=C.uuid;let W=c[N];W===void 0&&(W={},c[N]=W);let D=W[k];D===void 0&&(D=U.clone(),W[k]=D,C.addEventListener("dispose",w)),U=D}if(U.visible=C.visible,U.wireframe=C.wireframe,T===Ri?U.side=C.shadowSide!==null?C.shadowSide:C.side:U.side=C.shadowSide!==null?C.shadowSide:p[C.side],U.alphaMap=C.alphaMap,U.alphaTest=C.alphaToCoverage===!0?.5:C.alphaTest,U.map=C.map,U.clipShadows=C.clipShadows,U.clippingPlanes=C.clippingPlanes,U.clipIntersection=C.clipIntersection,U.displacementMap=C.displacementMap,U.displacementScale=C.displacementScale,U.displacementBias=C.displacementBias,U.wireframeLinewidth=C.wireframeLinewidth,U.linewidth=C.linewidth,g.isPointLight===!0&&U.isMeshDistanceMaterial===!0){const N=i.properties.get(U);N.light=g}return U}function b(y,C,g,T,U){if(y.visible===!1)return;if(y.layers.test(C.layers)&&(y.isMesh||y.isLine||y.isPoints)&&(y.castShadow||y.receiveShadow&&U===Ri)&&(!y.frustumCulled||n.intersectsObject(y))){y.modelViewMatrix.multiplyMatrices(g.matrixWorldInverse,y.matrixWorld);const k=e.update(y),W=y.material;if(Array.isArray(W)){const D=k.groups;for(let z=0,H=D.length;z<H;z++){const j=D[z],Q=W[j.materialIndex];if(Q&&Q.visible){const le=A(y,Q,T,U);y.onBeforeShadow(i,y,C,g,k,le,j),i.renderBufferDirect(g,null,k,le,y,j),y.onAfterShadow(i,y,C,g,k,le,j)}}}else if(W.visible){const D=A(y,W,T,U);y.onBeforeShadow(i,y,C,g,k,D,null),i.renderBufferDirect(g,null,k,D,y,null),y.onAfterShadow(i,y,C,g,k,D,null)}}const N=y.children;for(let k=0,W=N.length;k<W;k++)b(N[k],C,g,T,U)}function w(y){y.target.removeEventListener("dispose",w);for(const g in c){const T=c[g],U=y.target.uuid;U in T&&(T[U].dispose(),delete T[U])}}}function Fp(i,e){function t(){let P=!1;const ie=new ft;let q=null;const me=new ft(0,0,0,0);return{setMask:function(se){q!==se&&!P&&(i.colorMask(se,se,se,se),q=se)},setLocked:function(se){P=se},setClear:function(se,$,Se,Le,lt){lt===!0&&(se*=Le,$*=Le,Se*=Le),ie.set(se,$,Se,Le),me.equals(ie)===!1&&(i.clearColor(se,$,Se,Le),me.copy(ie))},reset:function(){P=!1,q=null,me.set(-1,0,0,0)}}}function n(){let P=!1,ie=!1,q=null,me=null,se=null;return{setReversed:function($){if(ie!==$){const Se=e.get("EXT_clip_control");$?Se.clipControlEXT(Se.LOWER_LEFT_EXT,Se.ZERO_TO_ONE_EXT):Se.clipControlEXT(Se.LOWER_LEFT_EXT,Se.NEGATIVE_ONE_TO_ONE_EXT),ie=$;const Le=se;se=null,this.setClear(Le)}},getReversed:function(){return ie},setTest:function($){$?ee(i.DEPTH_TEST):ye(i.DEPTH_TEST)},setMask:function($){q!==$&&!P&&(i.depthMask($),q=$)},setFunc:function($){if(ie&&($=ec[$]),me!==$){switch($){case us:i.depthFunc(i.NEVER);break;case fs:i.depthFunc(i.ALWAYS);break;case hs:i.depthFunc(i.LESS);break;case hi:i.depthFunc(i.LEQUAL);break;case ds:i.depthFunc(i.EQUAL);break;case ps:i.depthFunc(i.GEQUAL);break;case ms:i.depthFunc(i.GREATER);break;case _s:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}me=$}},setLocked:function($){P=$},setClear:function($){se!==$&&(se=$,ie&&($=1-$),i.clearDepth($))},reset:function(){P=!1,q=null,me=null,se=null,ie=!1}}}function r(){let P=!1,ie=null,q=null,me=null,se=null,$=null,Se=null,Le=null,lt=null;return{setTest:function($e){P||($e?ee(i.STENCIL_TEST):ye(i.STENCIL_TEST))},setMask:function($e){ie!==$e&&!P&&(i.stencilMask($e),ie=$e)},setFunc:function($e,rn,Yt){(q!==$e||me!==rn||se!==Yt)&&(i.stencilFunc($e,rn,Yt),q=$e,me=rn,se=Yt)},setOp:function($e,rn,Yt){($!==$e||Se!==rn||Le!==Yt)&&(i.stencilOp($e,rn,Yt),$=$e,Se=rn,Le=Yt)},setLocked:function($e){P=$e},setClear:function($e){lt!==$e&&(i.clearStencil($e),lt=$e)},reset:function(){P=!1,ie=null,q=null,me=null,se=null,$=null,Se=null,Le=null,lt=null}}}const s=new t,a=new n,o=new r,l=new WeakMap,c=new WeakMap;let h={},p={},u={},m=new WeakMap,v=[],E=null,d=!1,f=null,S=null,A=null,b=null,w=null,y=null,C=null,g=new Ye(0,0,0),T=0,U=!1,R=null,N=null,k=null,W=null,D=null;const z=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let H=!1,j=0;const Q=i.getParameter(i.VERSION);Q.indexOf("WebGL")!==-1?(j=parseFloat(/^WebGL (\d)/.exec(Q)[1]),H=j>=1):Q.indexOf("OpenGL ES")!==-1&&(j=parseFloat(/^OpenGL ES (\d)/.exec(Q)[1]),H=j>=2);let le=null,ve={};const pe=i.getParameter(i.SCISSOR_BOX),Ae=i.getParameter(i.VIEWPORT),Fe=new ft().fromArray(pe),we=new ft().fromArray(Ae);function Y(P,ie,q,me){const se=new Uint8Array(4),$=i.createTexture();i.bindTexture(P,$),i.texParameteri(P,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(P,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let Se=0;Se<q;Se++)P===i.TEXTURE_3D||P===i.TEXTURE_2D_ARRAY?i.texImage3D(ie,0,i.RGBA,1,1,me,0,i.RGBA,i.UNSIGNED_BYTE,se):i.texImage2D(ie+Se,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,se);return $}const oe={};oe[i.TEXTURE_2D]=Y(i.TEXTURE_2D,i.TEXTURE_2D,1),oe[i.TEXTURE_CUBE_MAP]=Y(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),oe[i.TEXTURE_2D_ARRAY]=Y(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),oe[i.TEXTURE_3D]=Y(i.TEXTURE_3D,i.TEXTURE_3D,1,1),s.setClear(0,0,0,1),a.setClear(1),o.setClear(0),ee(i.DEPTH_TEST),a.setFunc(hi),dt(!1),st(Sa),ee(i.CULL_FACE),nt(hn);function ee(P){h[P]!==!0&&(i.enable(P),h[P]=!0)}function ye(P){h[P]!==!1&&(i.disable(P),h[P]=!1)}function Ce(P,ie){return u[P]!==ie?(i.bindFramebuffer(P,ie),u[P]=ie,P===i.DRAW_FRAMEBUFFER&&(u[i.FRAMEBUFFER]=ie),P===i.FRAMEBUFFER&&(u[i.DRAW_FRAMEBUFFER]=ie),!0):!1}function be(P,ie){let q=v,me=!1;if(P){q=m.get(ie),q===void 0&&(q=[],m.set(ie,q));const se=P.textures;if(q.length!==se.length||q[0]!==i.COLOR_ATTACHMENT0){for(let $=0,Se=se.length;$<Se;$++)q[$]=i.COLOR_ATTACHMENT0+$;q.length=se.length,me=!0}}else q[0]!==i.BACK&&(q[0]=i.BACK,me=!0);me&&i.drawBuffers(q)}function rt(P){return E!==P?(i.useProgram(P),E=P,!0):!1}const ze={[Nn]:i.FUNC_ADD,[El]:i.FUNC_SUBTRACT,[Tl]:i.FUNC_REVERSE_SUBTRACT};ze[yl]=i.MIN,ze[bl]=i.MAX;const Ze={[Al]:i.ZERO,[Rl]:i.ONE,[wl]:i.SRC_COLOR,[ls]:i.SRC_ALPHA,[Il]:i.SRC_ALPHA_SATURATE,[Ll]:i.DST_COLOR,[Pl]:i.DST_ALPHA,[Cl]:i.ONE_MINUS_SRC_COLOR,[cs]:i.ONE_MINUS_SRC_ALPHA,[Ul]:i.ONE_MINUS_DST_COLOR,[Dl]:i.ONE_MINUS_DST_ALPHA,[Nl]:i.CONSTANT_COLOR,[Fl]:i.ONE_MINUS_CONSTANT_COLOR,[Ol]:i.CONSTANT_ALPHA,[Bl]:i.ONE_MINUS_CONSTANT_ALPHA};function nt(P,ie,q,me,se,$,Se,Le,lt,$e){if(P===hn){d===!0&&(ye(i.BLEND),d=!1);return}if(d===!1&&(ee(i.BLEND),d=!0),P!==Sl){if(P!==f||$e!==U){if((S!==Nn||w!==Nn)&&(i.blendEquation(i.FUNC_ADD),S=Nn,w=Nn),$e)switch(P){case ci:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Ea:i.blendFunc(i.ONE,i.ONE);break;case Ta:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case ya:i.blendFuncSeparate(i.DST_COLOR,i.ONE_MINUS_SRC_ALPHA,i.ZERO,i.ONE);break;default:Xe("WebGLState: Invalid blending: ",P);break}else switch(P){case ci:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Ea:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE,i.ONE,i.ONE);break;case Ta:Xe("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case ya:Xe("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Xe("WebGLState: Invalid blending: ",P);break}A=null,b=null,y=null,C=null,g.set(0,0,0),T=0,f=P,U=$e}return}se=se||ie,$=$||q,Se=Se||me,(ie!==S||se!==w)&&(i.blendEquationSeparate(ze[ie],ze[se]),S=ie,w=se),(q!==A||me!==b||$!==y||Se!==C)&&(i.blendFuncSeparate(Ze[q],Ze[me],Ze[$],Ze[Se]),A=q,b=me,y=$,C=Se),(Le.equals(g)===!1||lt!==T)&&(i.blendColor(Le.r,Le.g,Le.b,lt),g.copy(Le),T=lt),f=P,U=!1}function Be(P,ie){P.side===un?ye(i.CULL_FACE):ee(i.CULL_FACE);let q=P.side===At;ie&&(q=!q),dt(q),P.blending===ci&&P.transparent===!1?nt(hn):nt(P.blending,P.blendEquation,P.blendSrc,P.blendDst,P.blendEquationAlpha,P.blendSrcAlpha,P.blendDstAlpha,P.blendColor,P.blendAlpha,P.premultipliedAlpha),a.setFunc(P.depthFunc),a.setTest(P.depthTest),a.setMask(P.depthWrite),s.setMask(P.colorWrite);const me=P.stencilWrite;o.setTest(me),me&&(o.setMask(P.stencilWriteMask),o.setFunc(P.stencilFunc,P.stencilRef,P.stencilFuncMask),o.setOp(P.stencilFail,P.stencilZFail,P.stencilZPass)),L(P.polygonOffset,P.polygonOffsetFactor,P.polygonOffsetUnits),P.alphaToCoverage===!0?ee(i.SAMPLE_ALPHA_TO_COVERAGE):ye(i.SAMPLE_ALPHA_TO_COVERAGE)}function dt(P){R!==P&&(P?i.frontFace(i.CW):i.frontFace(i.CCW),R=P)}function st(P){P!==xl?(ee(i.CULL_FACE),P!==N&&(P===Sa?i.cullFace(i.BACK):P===vl?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):ye(i.CULL_FACE),N=P}function wt(P){P!==k&&(H&&i.lineWidth(P),k=P)}function L(P,ie,q){P?(ee(i.POLYGON_OFFSET_FILL),(W!==ie||D!==q)&&(W=ie,D=q,a.getReversed()&&(ie=-ie),i.polygonOffset(ie,q))):ye(i.POLYGON_OFFSET_FILL)}function pt(P){P?ee(i.SCISSOR_TEST):ye(i.SCISSOR_TEST)}function Ge(P){P===void 0&&(P=i.TEXTURE0+z-1),le!==P&&(i.activeTexture(P),le=P)}function et(P,ie,q){q===void 0&&(le===null?q=i.TEXTURE0+z-1:q=le);let me=ve[q];me===void 0&&(me={type:void 0,texture:void 0},ve[q]=me),(me.type!==P||me.texture!==ie)&&(le!==q&&(i.activeTexture(q),le=q),i.bindTexture(P,ie||oe[P]),me.type=P,me.texture=ie)}function ce(){const P=ve[le];P!==void 0&&P.type!==void 0&&(i.bindTexture(P.type,null),P.type=void 0,P.texture=void 0)}function at(){try{i.compressedTexImage2D(...arguments)}catch(P){Xe("WebGLState:",P)}}function M(){try{i.compressedTexImage3D(...arguments)}catch(P){Xe("WebGLState:",P)}}function _(){try{i.texSubImage2D(...arguments)}catch(P){Xe("WebGLState:",P)}}function O(){try{i.texSubImage3D(...arguments)}catch(P){Xe("WebGLState:",P)}}function K(){try{i.compressedTexSubImage2D(...arguments)}catch(P){Xe("WebGLState:",P)}}function J(){try{i.compressedTexSubImage3D(...arguments)}catch(P){Xe("WebGLState:",P)}}function te(){try{i.texStorage2D(...arguments)}catch(P){Xe("WebGLState:",P)}}function ae(){try{i.texStorage3D(...arguments)}catch(P){Xe("WebGLState:",P)}}function X(){try{i.texImage2D(...arguments)}catch(P){Xe("WebGLState:",P)}}function Z(){try{i.texImage3D(...arguments)}catch(P){Xe("WebGLState:",P)}}function de(P){return p[P]!==void 0?p[P]:i.getParameter(P)}function ge(P,ie){p[P]!==ie&&(i.pixelStorei(P,ie),p[P]=ie)}function re(P){Fe.equals(P)===!1&&(i.scissor(P.x,P.y,P.z,P.w),Fe.copy(P))}function ne(P){we.equals(P)===!1&&(i.viewport(P.x,P.y,P.z,P.w),we.copy(P))}function Pe(P,ie){let q=c.get(ie);q===void 0&&(q=new WeakMap,c.set(ie,q));let me=q.get(P);me===void 0&&(me=i.getUniformBlockIndex(ie,P.name),q.set(P,me))}function Ie(P,ie){const me=c.get(ie).get(P);l.get(ie)!==me&&(i.uniformBlockBinding(ie,me,P.__bindingPointIndex),l.set(ie,me))}function qe(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),a.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),i.pixelStorei(i.PACK_ALIGNMENT,4),i.pixelStorei(i.UNPACK_ALIGNMENT,4),i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,!1),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,i.BROWSER_DEFAULT_WEBGL),i.pixelStorei(i.PACK_ROW_LENGTH,0),i.pixelStorei(i.PACK_SKIP_PIXELS,0),i.pixelStorei(i.PACK_SKIP_ROWS,0),i.pixelStorei(i.UNPACK_ROW_LENGTH,0),i.pixelStorei(i.UNPACK_IMAGE_HEIGHT,0),i.pixelStorei(i.UNPACK_SKIP_PIXELS,0),i.pixelStorei(i.UNPACK_SKIP_ROWS,0),i.pixelStorei(i.UNPACK_SKIP_IMAGES,0),h={},p={},le=null,ve={},u={},m=new WeakMap,v=[],E=null,d=!1,f=null,S=null,A=null,b=null,w=null,y=null,C=null,g=new Ye(0,0,0),T=0,U=!1,R=null,N=null,k=null,W=null,D=null,Fe.set(0,0,i.canvas.width,i.canvas.height),we.set(0,0,i.canvas.width,i.canvas.height),s.reset(),a.reset(),o.reset()}return{buffers:{color:s,depth:a,stencil:o},enable:ee,disable:ye,bindFramebuffer:Ce,drawBuffers:be,useProgram:rt,setBlending:nt,setMaterial:Be,setFlipSided:dt,setCullFace:st,setLineWidth:wt,setPolygonOffset:L,setScissorTest:pt,activeTexture:Ge,bindTexture:et,unbindTexture:ce,compressedTexImage2D:at,compressedTexImage3D:M,texImage2D:X,texImage3D:Z,pixelStorei:ge,getParameter:de,updateUBOMapping:Pe,uniformBlockBinding:Ie,texStorage2D:te,texStorage3D:ae,texSubImage2D:_,texSubImage3D:O,compressedTexSubImage2D:K,compressedTexSubImage3D:J,scissor:re,viewport:ne,reset:qe}}function Op(i,e,t,n,r,s,a){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new ke,h=new WeakMap,p=new Set;let u;const m=new WeakMap;let v=!1;try{v=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function E(M,_){return v?new OffscreenCanvas(M,_):Mr("canvas")}function d(M,_,O){let K=1;const J=at(M);if((J.width>O||J.height>O)&&(K=O/Math.max(J.width,J.height)),K<1)if(typeof HTMLImageElement<"u"&&M instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&M instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&M instanceof ImageBitmap||typeof VideoFrame<"u"&&M instanceof VideoFrame){const te=Math.floor(K*J.width),ae=Math.floor(K*J.height);u===void 0&&(u=E(te,ae));const X=_?E(te,ae):u;return X.width=te,X.height=ae,X.getContext("2d").drawImage(M,0,0,te,ae),Re("WebGLRenderer: Texture has been resized from ("+J.width+"x"+J.height+") to ("+te+"x"+ae+")."),X}else return"data"in M&&Re("WebGLRenderer: Image in DataTexture is too big ("+J.width+"x"+J.height+")."),M;return M}function f(M){return M.generateMipmaps}function S(M){i.generateMipmap(M)}function A(M){return M.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:M.isWebGL3DRenderTarget?i.TEXTURE_3D:M.isWebGLArrayRenderTarget||M.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function b(M,_,O,K,J,te=!1){if(M!==null){if(i[M]!==void 0)return i[M];Re("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+M+"'")}let ae;K&&(ae=e.get("EXT_texture_norm16"),ae||Re("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let X=_;if(_===i.RED&&(O===i.FLOAT&&(X=i.R32F),O===i.HALF_FLOAT&&(X=i.R16F),O===i.UNSIGNED_BYTE&&(X=i.R8),O===i.UNSIGNED_SHORT&&ae&&(X=ae.R16_EXT),O===i.SHORT&&ae&&(X=ae.R16_SNORM_EXT)),_===i.RED_INTEGER&&(O===i.UNSIGNED_BYTE&&(X=i.R8UI),O===i.UNSIGNED_SHORT&&(X=i.R16UI),O===i.UNSIGNED_INT&&(X=i.R32UI),O===i.BYTE&&(X=i.R8I),O===i.SHORT&&(X=i.R16I),O===i.INT&&(X=i.R32I)),_===i.RG&&(O===i.FLOAT&&(X=i.RG32F),O===i.HALF_FLOAT&&(X=i.RG16F),O===i.UNSIGNED_BYTE&&(X=i.RG8),O===i.UNSIGNED_SHORT&&ae&&(X=ae.RG16_EXT),O===i.SHORT&&ae&&(X=ae.RG16_SNORM_EXT)),_===i.RG_INTEGER&&(O===i.UNSIGNED_BYTE&&(X=i.RG8UI),O===i.UNSIGNED_SHORT&&(X=i.RG16UI),O===i.UNSIGNED_INT&&(X=i.RG32UI),O===i.BYTE&&(X=i.RG8I),O===i.SHORT&&(X=i.RG16I),O===i.INT&&(X=i.RG32I)),_===i.RGB_INTEGER&&(O===i.UNSIGNED_BYTE&&(X=i.RGB8UI),O===i.UNSIGNED_SHORT&&(X=i.RGB16UI),O===i.UNSIGNED_INT&&(X=i.RGB32UI),O===i.BYTE&&(X=i.RGB8I),O===i.SHORT&&(X=i.RGB16I),O===i.INT&&(X=i.RGB32I)),_===i.RGBA_INTEGER&&(O===i.UNSIGNED_BYTE&&(X=i.RGBA8UI),O===i.UNSIGNED_SHORT&&(X=i.RGBA16UI),O===i.UNSIGNED_INT&&(X=i.RGBA32UI),O===i.BYTE&&(X=i.RGBA8I),O===i.SHORT&&(X=i.RGBA16I),O===i.INT&&(X=i.RGBA32I)),_===i.RGB&&(O===i.UNSIGNED_SHORT&&ae&&(X=ae.RGB16_EXT),O===i.SHORT&&ae&&(X=ae.RGB16_SNORM_EXT),O===i.UNSIGNED_INT_5_9_9_9_REV&&(X=i.RGB9_E5),O===i.UNSIGNED_INT_10F_11F_11F_REV&&(X=i.R11F_G11F_B10F)),_===i.RGBA){const Z=te?xr:He.getTransfer(J);O===i.FLOAT&&(X=i.RGBA32F),O===i.HALF_FLOAT&&(X=i.RGBA16F),O===i.UNSIGNED_BYTE&&(X=Z===Ke?i.SRGB8_ALPHA8:i.RGBA8),O===i.UNSIGNED_SHORT&&ae&&(X=ae.RGBA16_EXT),O===i.SHORT&&ae&&(X=ae.RGBA16_SNORM_EXT),O===i.UNSIGNED_SHORT_4_4_4_4&&(X=i.RGBA4),O===i.UNSIGNED_SHORT_5_5_5_1&&(X=i.RGB5_A1)}return(X===i.R16F||X===i.R32F||X===i.RG16F||X===i.RG32F||X===i.RGBA16F||X===i.RGBA32F)&&e.get("EXT_color_buffer_float"),X}function w(M,_){let O;return M?_===null||_===tn||_===Ii?O=i.DEPTH24_STENCIL8:_===Ht?O=i.DEPTH32F_STENCIL8:_===Ui&&(O=i.DEPTH24_STENCIL8,Re("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):_===null||_===tn||_===Ii?O=i.DEPTH_COMPONENT24:_===Ht?O=i.DEPTH_COMPONENT32F:_===Ui&&(O=i.DEPTH_COMPONENT16),O}function y(M,_){return f(M)===!0||M.isFramebufferTexture&&M.minFilter!==xt&&M.minFilter!==Et?Math.log2(Math.max(_.width,_.height))+1:M.mipmaps!==void 0&&M.mipmaps.length>0?M.mipmaps.length:M.isCompressedTexture&&Array.isArray(M.image)?_.mipmaps.length:1}function C(M){const _=M.target;_.removeEventListener("dispose",C),T(_),_.isVideoTexture&&h.delete(_),_.isHTMLTexture&&p.delete(_)}function g(M){const _=M.target;_.removeEventListener("dispose",g),R(_)}function T(M){const _=n.get(M);if(_.__webglInit===void 0)return;const O=M.source,K=m.get(O);if(K){const J=K[_.__cacheKey];J.usedTimes--,J.usedTimes===0&&U(M),Object.keys(K).length===0&&m.delete(O)}n.remove(M)}function U(M){const _=n.get(M);i.deleteTexture(_.__webglTexture);const O=M.source,K=m.get(O);delete K[_.__cacheKey],a.memory.textures--}function R(M){const _=n.get(M);if(M.depthTexture&&(M.depthTexture.dispose(),n.remove(M.depthTexture)),M.isWebGLCubeRenderTarget)for(let K=0;K<6;K++){if(Array.isArray(_.__webglFramebuffer[K]))for(let J=0;J<_.__webglFramebuffer[K].length;J++)i.deleteFramebuffer(_.__webglFramebuffer[K][J]);else i.deleteFramebuffer(_.__webglFramebuffer[K]);_.__webglDepthbuffer&&i.deleteRenderbuffer(_.__webglDepthbuffer[K])}else{if(Array.isArray(_.__webglFramebuffer))for(let K=0;K<_.__webglFramebuffer.length;K++)i.deleteFramebuffer(_.__webglFramebuffer[K]);else i.deleteFramebuffer(_.__webglFramebuffer);if(_.__webglDepthbuffer&&i.deleteRenderbuffer(_.__webglDepthbuffer),_.__webglMultisampledFramebuffer&&i.deleteFramebuffer(_.__webglMultisampledFramebuffer),_.__webglColorRenderbuffer)for(let K=0;K<_.__webglColorRenderbuffer.length;K++)_.__webglColorRenderbuffer[K]&&i.deleteRenderbuffer(_.__webglColorRenderbuffer[K]);_.__webglDepthRenderbuffer&&i.deleteRenderbuffer(_.__webglDepthRenderbuffer)}const O=M.textures;for(let K=0,J=O.length;K<J;K++){const te=n.get(O[K]);te.__webglTexture&&(i.deleteTexture(te.__webglTexture),a.memory.textures--),n.remove(O[K])}n.remove(M)}let N=0;function k(){N=0}function W(){return N}function D(M){N=M}function z(){const M=N;return M>=r.maxTextures&&Re("WebGLTextures: Trying to use "+M+" texture units while this GPU supports only "+r.maxTextures),N+=1,M}function H(M){const _=[];return _.push(M.wrapS),_.push(M.wrapT),_.push(M.wrapR||0),_.push(M.magFilter),_.push(M.minFilter),_.push(M.anisotropy),_.push(M.internalFormat),_.push(M.format),_.push(M.type),_.push(M.generateMipmaps),_.push(M.premultiplyAlpha),_.push(M.flipY),_.push(M.unpackAlignment),_.push(M.colorSpace),_.join()}function j(M,_){const O=n.get(M);if(M.isVideoTexture&&et(M),M.isRenderTargetTexture===!1&&M.isExternalTexture!==!0&&M.version>0&&O.__version!==M.version){const K=M.image;if(K===null)Re("WebGLRenderer: Texture marked for update but no image data found.");else if(K.complete===!1)Re("WebGLRenderer: Texture marked for update but image is incomplete");else{ye(O,M,_);return}}else M.isExternalTexture&&(O.__webglTexture=M.sourceTexture?M.sourceTexture:null);t.bindTexture(i.TEXTURE_2D,O.__webglTexture,i.TEXTURE0+_)}function Q(M,_){const O=n.get(M);if(M.isRenderTargetTexture===!1&&M.version>0&&O.__version!==M.version){ye(O,M,_);return}else M.isExternalTexture&&(O.__webglTexture=M.sourceTexture?M.sourceTexture:null);t.bindTexture(i.TEXTURE_2D_ARRAY,O.__webglTexture,i.TEXTURE0+_)}function le(M,_){const O=n.get(M);if(M.isRenderTargetTexture===!1&&M.version>0&&O.__version!==M.version){ye(O,M,_);return}t.bindTexture(i.TEXTURE_3D,O.__webglTexture,i.TEXTURE0+_)}function ve(M,_){const O=n.get(M);if(M.isCubeDepthTexture!==!0&&M.version>0&&O.__version!==M.version){Ce(O,M,_);return}t.bindTexture(i.TEXTURE_CUBE_MAP,O.__webglTexture,i.TEXTURE0+_)}const pe={[gs]:i.REPEAT,[fn]:i.CLAMP_TO_EDGE,[xs]:i.MIRRORED_REPEAT},Ae={[xt]:i.NEAREST,[Vl]:i.NEAREST_MIPMAP_NEAREST,[Gi]:i.NEAREST_MIPMAP_LINEAR,[Et]:i.LINEAR,[Pr]:i.LINEAR_MIPMAP_NEAREST,[On]:i.LINEAR_MIPMAP_LINEAR},Fe={[Wl]:i.NEVER,[Zl]:i.ALWAYS,[Xl]:i.LESS,[oa]:i.LEQUAL,[ql]:i.EQUAL,[la]:i.GEQUAL,[Yl]:i.GREATER,[Kl]:i.NOTEQUAL};function we(M,_){if(_.type===Ht&&e.has("OES_texture_float_linear")===!1&&(_.magFilter===Et||_.magFilter===Pr||_.magFilter===Gi||_.magFilter===On||_.minFilter===Et||_.minFilter===Pr||_.minFilter===Gi||_.minFilter===On)&&Re("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(M,i.TEXTURE_WRAP_S,pe[_.wrapS]),i.texParameteri(M,i.TEXTURE_WRAP_T,pe[_.wrapT]),(M===i.TEXTURE_3D||M===i.TEXTURE_2D_ARRAY)&&i.texParameteri(M,i.TEXTURE_WRAP_R,pe[_.wrapR]),i.texParameteri(M,i.TEXTURE_MAG_FILTER,Ae[_.magFilter]),i.texParameteri(M,i.TEXTURE_MIN_FILTER,Ae[_.minFilter]),_.compareFunction&&(i.texParameteri(M,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(M,i.TEXTURE_COMPARE_FUNC,Fe[_.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(_.magFilter===xt||_.minFilter!==Gi&&_.minFilter!==On||_.type===Ht&&e.has("OES_texture_float_linear")===!1)return;if(_.anisotropy>1||n.get(_).__currentAnisotropy){const O=e.get("EXT_texture_filter_anisotropic");i.texParameterf(M,O.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(_.anisotropy,r.getMaxAnisotropy())),n.get(_).__currentAnisotropy=_.anisotropy}}}function Y(M,_){let O=!1;M.__webglInit===void 0&&(M.__webglInit=!0,_.addEventListener("dispose",C));const K=_.source;let J=m.get(K);J===void 0&&(J={},m.set(K,J));const te=H(_);if(te!==M.__cacheKey){J[te]===void 0&&(J[te]={texture:i.createTexture(),usedTimes:0},a.memory.textures++,O=!0),J[te].usedTimes++;const ae=J[M.__cacheKey];ae!==void 0&&(J[M.__cacheKey].usedTimes--,ae.usedTimes===0&&U(_)),M.__cacheKey=te,M.__webglTexture=J[te].texture}return O}function oe(M,_,O){return Math.floor(Math.floor(M/O)/_)}function ee(M,_,O,K){const te=M.updateRanges;if(te.length===0)t.texSubImage2D(i.TEXTURE_2D,0,0,0,_.width,_.height,O,K,_.data);else{te.sort((ge,re)=>ge.start-re.start);let ae=0;for(let ge=1;ge<te.length;ge++){const re=te[ae],ne=te[ge],Pe=re.start+re.count,Ie=oe(ne.start,_.width,4),qe=oe(re.start,_.width,4);ne.start<=Pe+1&&Ie===qe&&oe(ne.start+ne.count-1,_.width,4)===Ie?re.count=Math.max(re.count,ne.start+ne.count-re.start):(++ae,te[ae]=ne)}te.length=ae+1;const X=t.getParameter(i.UNPACK_ROW_LENGTH),Z=t.getParameter(i.UNPACK_SKIP_PIXELS),de=t.getParameter(i.UNPACK_SKIP_ROWS);t.pixelStorei(i.UNPACK_ROW_LENGTH,_.width);for(let ge=0,re=te.length;ge<re;ge++){const ne=te[ge],Pe=Math.floor(ne.start/4),Ie=Math.ceil(ne.count/4),qe=Pe%_.width,P=Math.floor(Pe/_.width),ie=Ie,q=1;t.pixelStorei(i.UNPACK_SKIP_PIXELS,qe),t.pixelStorei(i.UNPACK_SKIP_ROWS,P),t.texSubImage2D(i.TEXTURE_2D,0,qe,P,ie,q,O,K,_.data)}M.clearUpdateRanges(),t.pixelStorei(i.UNPACK_ROW_LENGTH,X),t.pixelStorei(i.UNPACK_SKIP_PIXELS,Z),t.pixelStorei(i.UNPACK_SKIP_ROWS,de)}}function ye(M,_,O){let K=i.TEXTURE_2D;(_.isDataArrayTexture||_.isCompressedArrayTexture)&&(K=i.TEXTURE_2D_ARRAY),_.isData3DTexture&&(K=i.TEXTURE_3D);const J=Y(M,_),te=_.source;t.bindTexture(K,M.__webglTexture,i.TEXTURE0+O);const ae=n.get(te);if(te.version!==ae.__version||J===!0){if(t.activeTexture(i.TEXTURE0+O),(typeof ImageBitmap<"u"&&_.image instanceof ImageBitmap)===!1){const q=He.getPrimaries(He.workingColorSpace),me=_.colorSpace===bn?null:He.getPrimaries(_.colorSpace),se=_.colorSpace===bn||q===me?i.NONE:i.BROWSER_DEFAULT_WEBGL;t.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,_.flipY),t.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),t.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,se)}t.pixelStorei(i.UNPACK_ALIGNMENT,_.unpackAlignment);let Z=d(_.image,!1,r.maxTextureSize);Z=ce(_,Z);const de=s.convert(_.format,_.colorSpace),ge=s.convert(_.type);let re=b(_.internalFormat,de,ge,_.normalized,_.colorSpace,_.isVideoTexture);we(K,_);let ne;const Pe=_.mipmaps,Ie=_.isVideoTexture!==!0,qe=ae.__version===void 0||J===!0,P=te.dataReady,ie=y(_,Z);if(_.isDepthTexture)re=w(_.format===Bn,_.type),qe&&(Ie?t.texStorage2D(i.TEXTURE_2D,1,re,Z.width,Z.height):t.texImage2D(i.TEXTURE_2D,0,re,Z.width,Z.height,0,de,ge,null));else if(_.isDataTexture)if(Pe.length>0){Ie&&qe&&t.texStorage2D(i.TEXTURE_2D,ie,re,Pe[0].width,Pe[0].height);for(let q=0,me=Pe.length;q<me;q++)ne=Pe[q],Ie?P&&t.texSubImage2D(i.TEXTURE_2D,q,0,0,ne.width,ne.height,de,ge,ne.data):t.texImage2D(i.TEXTURE_2D,q,re,ne.width,ne.height,0,de,ge,ne.data);_.generateMipmaps=!1}else Ie?(qe&&t.texStorage2D(i.TEXTURE_2D,ie,re,Z.width,Z.height),P&&ee(_,Z,de,ge)):t.texImage2D(i.TEXTURE_2D,0,re,Z.width,Z.height,0,de,ge,Z.data);else if(_.isCompressedTexture)if(_.isCompressedArrayTexture){Ie&&qe&&t.texStorage3D(i.TEXTURE_2D_ARRAY,ie,re,Pe[0].width,Pe[0].height,Z.depth);for(let q=0,me=Pe.length;q<me;q++)if(ne=Pe[q],_.format!==kt)if(de!==null)if(Ie){if(P)if(_.layerUpdates.size>0){const se=Qa(ne.width,ne.height,_.format,_.type);for(const $ of _.layerUpdates){const Se=ne.data.subarray($*se/ne.data.BYTES_PER_ELEMENT,($+1)*se/ne.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,q,0,0,$,ne.width,ne.height,1,de,Se)}_.clearLayerUpdates()}else t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,q,0,0,0,ne.width,ne.height,Z.depth,de,ne.data)}else t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,q,re,ne.width,ne.height,Z.depth,0,ne.data,0,0);else Re("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Ie?P&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,q,0,0,0,ne.width,ne.height,Z.depth,de,ge,ne.data):t.texImage3D(i.TEXTURE_2D_ARRAY,q,re,ne.width,ne.height,Z.depth,0,de,ge,ne.data)}else{Ie&&qe&&t.texStorage2D(i.TEXTURE_2D,ie,re,Pe[0].width,Pe[0].height);for(let q=0,me=Pe.length;q<me;q++)ne=Pe[q],_.format!==kt?de!==null?Ie?P&&t.compressedTexSubImage2D(i.TEXTURE_2D,q,0,0,ne.width,ne.height,de,ne.data):t.compressedTexImage2D(i.TEXTURE_2D,q,re,ne.width,ne.height,0,ne.data):Re("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Ie?P&&t.texSubImage2D(i.TEXTURE_2D,q,0,0,ne.width,ne.height,de,ge,ne.data):t.texImage2D(i.TEXTURE_2D,q,re,ne.width,ne.height,0,de,ge,ne.data)}else if(_.isDataArrayTexture)if(Ie){if(qe&&t.texStorage3D(i.TEXTURE_2D_ARRAY,ie,re,Z.width,Z.height,Z.depth),P)if(_.layerUpdates.size>0){const q=Qa(Z.width,Z.height,_.format,_.type);for(const me of _.layerUpdates){const se=Z.data.subarray(me*q/Z.data.BYTES_PER_ELEMENT,(me+1)*q/Z.data.BYTES_PER_ELEMENT);t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,me,Z.width,Z.height,1,de,ge,se)}_.clearLayerUpdates()}else t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,Z.width,Z.height,Z.depth,de,ge,Z.data)}else t.texImage3D(i.TEXTURE_2D_ARRAY,0,re,Z.width,Z.height,Z.depth,0,de,ge,Z.data);else if(_.isData3DTexture)Ie?(qe&&t.texStorage3D(i.TEXTURE_3D,ie,re,Z.width,Z.height,Z.depth),P&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,Z.width,Z.height,Z.depth,de,ge,Z.data)):t.texImage3D(i.TEXTURE_3D,0,re,Z.width,Z.height,Z.depth,0,de,ge,Z.data);else if(_.isFramebufferTexture){if(qe)if(Ie)t.texStorage2D(i.TEXTURE_2D,ie,re,Z.width,Z.height);else{let q=Z.width,me=Z.height;for(let se=0;se<ie;se++)t.texImage2D(i.TEXTURE_2D,se,re,q,me,0,de,ge,null),q>>=1,me>>=1}}else if(_.isHTMLTexture){if("texElementImage2D"in i){const q=i.canvas;if(q.hasAttribute("layoutsubtree")||q.setAttribute("layoutsubtree","true"),Z.parentNode!==q){q.appendChild(Z),p.add(_),q.onpaint=Le=>{const lt=Le.changedElements;for(const $e of p)lt.includes($e.image)&&($e.needsUpdate=!0)},q.requestPaint();return}const me=0,se=i.RGBA,$=i.RGBA,Se=i.UNSIGNED_BYTE;i.texElementImage2D(i.TEXTURE_2D,me,se,$,Se,Z),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_MIN_FILTER,i.LINEAR),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_S,i.CLAMP_TO_EDGE),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_T,i.CLAMP_TO_EDGE)}}else if(Pe.length>0){if(Ie&&qe){const q=at(Pe[0]);t.texStorage2D(i.TEXTURE_2D,ie,re,q.width,q.height)}for(let q=0,me=Pe.length;q<me;q++)ne=Pe[q],Ie?P&&t.texSubImage2D(i.TEXTURE_2D,q,0,0,de,ge,ne):t.texImage2D(i.TEXTURE_2D,q,re,de,ge,ne);_.generateMipmaps=!1}else if(Ie){if(qe){const q=at(Z);t.texStorage2D(i.TEXTURE_2D,ie,re,q.width,q.height)}P&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,de,ge,Z)}else t.texImage2D(i.TEXTURE_2D,0,re,de,ge,Z);f(_)&&S(K),ae.__version=te.version,_.onUpdate&&_.onUpdate(_)}M.__version=_.version}function Ce(M,_,O){if(_.image.length!==6)return;const K=Y(M,_),J=_.source;t.bindTexture(i.TEXTURE_CUBE_MAP,M.__webglTexture,i.TEXTURE0+O);const te=n.get(J);if(J.version!==te.__version||K===!0){t.activeTexture(i.TEXTURE0+O);const ae=He.getPrimaries(He.workingColorSpace),X=_.colorSpace===bn?null:He.getPrimaries(_.colorSpace),Z=_.colorSpace===bn||ae===X?i.NONE:i.BROWSER_DEFAULT_WEBGL;t.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,_.flipY),t.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),t.pixelStorei(i.UNPACK_ALIGNMENT,_.unpackAlignment),t.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Z);const de=_.isCompressedTexture||_.image[0].isCompressedTexture,ge=_.image[0]&&_.image[0].isDataTexture,re=[];for(let $=0;$<6;$++)!de&&!ge?re[$]=d(_.image[$],!0,r.maxCubemapSize):re[$]=ge?_.image[$].image:_.image[$],re[$]=ce(_,re[$]);const ne=re[0],Pe=s.convert(_.format,_.colorSpace),Ie=s.convert(_.type),qe=b(_.internalFormat,Pe,Ie,_.normalized,_.colorSpace),P=_.isVideoTexture!==!0,ie=te.__version===void 0||K===!0,q=J.dataReady;let me=y(_,ne);we(i.TEXTURE_CUBE_MAP,_);let se;if(de){P&&ie&&t.texStorage2D(i.TEXTURE_CUBE_MAP,me,qe,ne.width,ne.height);for(let $=0;$<6;$++){se=re[$].mipmaps;for(let Se=0;Se<se.length;Se++){const Le=se[Se];_.format!==kt?Pe!==null?P?q&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,Se,0,0,Le.width,Le.height,Pe,Le.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,Se,qe,Le.width,Le.height,0,Le.data):Re("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):P?q&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,Se,0,0,Le.width,Le.height,Pe,Ie,Le.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,Se,qe,Le.width,Le.height,0,Pe,Ie,Le.data)}}}else{if(se=_.mipmaps,P&&ie){se.length>0&&me++;const $=at(re[0]);t.texStorage2D(i.TEXTURE_CUBE_MAP,me,qe,$.width,$.height)}for(let $=0;$<6;$++)if(ge){P?q&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,0,0,0,re[$].width,re[$].height,Pe,Ie,re[$].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,0,qe,re[$].width,re[$].height,0,Pe,Ie,re[$].data);for(let Se=0;Se<se.length;Se++){const lt=se[Se].image[$].image;P?q&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,Se+1,0,0,lt.width,lt.height,Pe,Ie,lt.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,Se+1,qe,lt.width,lt.height,0,Pe,Ie,lt.data)}}else{P?q&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,0,0,0,Pe,Ie,re[$]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,0,qe,Pe,Ie,re[$]);for(let Se=0;Se<se.length;Se++){const Le=se[Se];P?q&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,Se+1,0,0,Pe,Ie,Le.image[$]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,Se+1,qe,Pe,Ie,Le.image[$])}}}f(_)&&S(i.TEXTURE_CUBE_MAP),te.__version=J.version,_.onUpdate&&_.onUpdate(_)}M.__version=_.version}function be(M,_,O,K,J,te){const ae=s.convert(O.format,O.colorSpace),X=s.convert(O.type),Z=b(O.internalFormat,ae,X,O.normalized,O.colorSpace),de=n.get(_),ge=n.get(O);if(ge.__renderTarget=_,!de.__hasExternalTextures){const re=Math.max(1,_.width>>te),ne=Math.max(1,_.height>>te);J===i.TEXTURE_3D||J===i.TEXTURE_2D_ARRAY?t.texImage3D(J,te,Z,re,ne,_.depth,0,ae,X,null):t.texImage2D(J,te,Z,re,ne,0,ae,X,null)}t.bindFramebuffer(i.FRAMEBUFFER,M),Ge(_)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,K,J,ge.__webglTexture,0,pt(_)):(J===i.TEXTURE_2D||J>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&J<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,K,J,ge.__webglTexture,te),t.bindFramebuffer(i.FRAMEBUFFER,null)}function rt(M,_,O){if(i.bindRenderbuffer(i.RENDERBUFFER,M),_.depthBuffer){const K=_.depthTexture,J=K&&K.isDepthTexture?K.type:null,te=w(_.stencilBuffer,J),ae=_.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;Ge(_)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,pt(_),te,_.width,_.height):O?i.renderbufferStorageMultisample(i.RENDERBUFFER,pt(_),te,_.width,_.height):i.renderbufferStorage(i.RENDERBUFFER,te,_.width,_.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,ae,i.RENDERBUFFER,M)}else{const K=_.textures;for(let J=0;J<K.length;J++){const te=K[J],ae=s.convert(te.format,te.colorSpace),X=s.convert(te.type),Z=b(te.internalFormat,ae,X,te.normalized,te.colorSpace);Ge(_)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,pt(_),Z,_.width,_.height):O?i.renderbufferStorageMultisample(i.RENDERBUFFER,pt(_),Z,_.width,_.height):i.renderbufferStorage(i.RENDERBUFFER,Z,_.width,_.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function ze(M,_,O){const K=_.isWebGLCubeRenderTarget===!0;if(t.bindFramebuffer(i.FRAMEBUFFER,M),!(_.depthTexture&&_.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const J=n.get(_.depthTexture);if(J.__renderTarget=_,(!J.__webglTexture||_.depthTexture.image.width!==_.width||_.depthTexture.image.height!==_.height)&&(_.depthTexture.image.width=_.width,_.depthTexture.image.height=_.height,_.depthTexture.needsUpdate=!0),K){if(J.__webglInit===void 0&&(J.__webglInit=!0,_.depthTexture.addEventListener("dispose",C)),J.__webglTexture===void 0){J.__webglTexture=i.createTexture(),t.bindTexture(i.TEXTURE_CUBE_MAP,J.__webglTexture),we(i.TEXTURE_CUBE_MAP,_.depthTexture);const de=s.convert(_.depthTexture.format),ge=s.convert(_.depthTexture.type);let re;_.depthTexture.format===mn?re=i.DEPTH_COMPONENT24:_.depthTexture.format===Bn&&(re=i.DEPTH24_STENCIL8);for(let ne=0;ne<6;ne++)i.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ne,0,re,_.width,_.height,0,de,ge,null)}}else j(_.depthTexture,0);const te=J.__webglTexture,ae=pt(_),X=K?i.TEXTURE_CUBE_MAP_POSITIVE_X+O:i.TEXTURE_2D,Z=_.depthTexture.format===Bn?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;if(_.depthTexture.format===mn)Ge(_)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,Z,X,te,0,ae):i.framebufferTexture2D(i.FRAMEBUFFER,Z,X,te,0);else if(_.depthTexture.format===Bn)Ge(_)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,Z,X,te,0,ae):i.framebufferTexture2D(i.FRAMEBUFFER,Z,X,te,0);else throw new Error("Unknown depthTexture format")}function Ze(M){const _=n.get(M),O=M.isWebGLCubeRenderTarget===!0;if(_.__boundDepthTexture!==M.depthTexture){const K=M.depthTexture;if(_.__depthDisposeCallback&&_.__depthDisposeCallback(),K){const J=()=>{delete _.__boundDepthTexture,delete _.__depthDisposeCallback,K.removeEventListener("dispose",J)};K.addEventListener("dispose",J),_.__depthDisposeCallback=J}_.__boundDepthTexture=K}if(M.depthTexture&&!_.__autoAllocateDepthBuffer)if(O)for(let K=0;K<6;K++)ze(_.__webglFramebuffer[K],M,K);else{const K=M.texture.mipmaps;K&&K.length>0?ze(_.__webglFramebuffer[0],M,0):ze(_.__webglFramebuffer,M,0)}else if(O){_.__webglDepthbuffer=[];for(let K=0;K<6;K++)if(t.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer[K]),_.__webglDepthbuffer[K]===void 0)_.__webglDepthbuffer[K]=i.createRenderbuffer(),rt(_.__webglDepthbuffer[K],M,!1);else{const J=M.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,te=_.__webglDepthbuffer[K];i.bindRenderbuffer(i.RENDERBUFFER,te),i.framebufferRenderbuffer(i.FRAMEBUFFER,J,i.RENDERBUFFER,te)}}else{const K=M.texture.mipmaps;if(K&&K.length>0?t.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer[0]):t.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer),_.__webglDepthbuffer===void 0)_.__webglDepthbuffer=i.createRenderbuffer(),rt(_.__webglDepthbuffer,M,!1);else{const J=M.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,te=_.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,te),i.framebufferRenderbuffer(i.FRAMEBUFFER,J,i.RENDERBUFFER,te)}}t.bindFramebuffer(i.FRAMEBUFFER,null)}function nt(M,_,O){const K=n.get(M);_!==void 0&&be(K.__webglFramebuffer,M,M.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),O!==void 0&&Ze(M)}function Be(M){const _=M.texture,O=n.get(M),K=n.get(_);M.addEventListener("dispose",g);const J=M.textures,te=M.isWebGLCubeRenderTarget===!0,ae=J.length>1;if(ae||(K.__webglTexture===void 0&&(K.__webglTexture=i.createTexture()),K.__version=_.version,a.memory.textures++),te){O.__webglFramebuffer=[];for(let X=0;X<6;X++)if(_.mipmaps&&_.mipmaps.length>0){O.__webglFramebuffer[X]=[];for(let Z=0;Z<_.mipmaps.length;Z++)O.__webglFramebuffer[X][Z]=i.createFramebuffer()}else O.__webglFramebuffer[X]=i.createFramebuffer()}else{if(_.mipmaps&&_.mipmaps.length>0){O.__webglFramebuffer=[];for(let X=0;X<_.mipmaps.length;X++)O.__webglFramebuffer[X]=i.createFramebuffer()}else O.__webglFramebuffer=i.createFramebuffer();if(ae)for(let X=0,Z=J.length;X<Z;X++){const de=n.get(J[X]);de.__webglTexture===void 0&&(de.__webglTexture=i.createTexture(),a.memory.textures++)}if(M.samples>0&&Ge(M)===!1){O.__webglMultisampledFramebuffer=i.createFramebuffer(),O.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,O.__webglMultisampledFramebuffer);for(let X=0;X<J.length;X++){const Z=J[X];O.__webglColorRenderbuffer[X]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,O.__webglColorRenderbuffer[X]);const de=s.convert(Z.format,Z.colorSpace),ge=s.convert(Z.type),re=b(Z.internalFormat,de,ge,Z.normalized,Z.colorSpace,M.isXRRenderTarget===!0),ne=pt(M);i.renderbufferStorageMultisample(i.RENDERBUFFER,ne,re,M.width,M.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+X,i.RENDERBUFFER,O.__webglColorRenderbuffer[X])}i.bindRenderbuffer(i.RENDERBUFFER,null),M.depthBuffer&&(O.__webglDepthRenderbuffer=i.createRenderbuffer(),rt(O.__webglDepthRenderbuffer,M,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(te){t.bindTexture(i.TEXTURE_CUBE_MAP,K.__webglTexture),we(i.TEXTURE_CUBE_MAP,_);for(let X=0;X<6;X++)if(_.mipmaps&&_.mipmaps.length>0)for(let Z=0;Z<_.mipmaps.length;Z++)be(O.__webglFramebuffer[X][Z],M,_,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+X,Z);else be(O.__webglFramebuffer[X],M,_,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+X,0);f(_)&&S(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(ae){for(let X=0,Z=J.length;X<Z;X++){const de=J[X],ge=n.get(de);let re=i.TEXTURE_2D;(M.isWebGL3DRenderTarget||M.isWebGLArrayRenderTarget)&&(re=M.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(re,ge.__webglTexture),we(re,de),be(O.__webglFramebuffer,M,de,i.COLOR_ATTACHMENT0+X,re,0),f(de)&&S(re)}t.unbindTexture()}else{let X=i.TEXTURE_2D;if((M.isWebGL3DRenderTarget||M.isWebGLArrayRenderTarget)&&(X=M.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(X,K.__webglTexture),we(X,_),_.mipmaps&&_.mipmaps.length>0)for(let Z=0;Z<_.mipmaps.length;Z++)be(O.__webglFramebuffer[Z],M,_,i.COLOR_ATTACHMENT0,X,Z);else be(O.__webglFramebuffer,M,_,i.COLOR_ATTACHMENT0,X,0);f(_)&&S(X),t.unbindTexture()}M.depthBuffer&&Ze(M)}function dt(M){const _=M.textures;for(let O=0,K=_.length;O<K;O++){const J=_[O];if(f(J)){const te=A(M),ae=n.get(J).__webglTexture;t.bindTexture(te,ae),S(te),t.unbindTexture()}}}const st=[],wt=[];function L(M){if(M.samples>0){if(Ge(M)===!1){const _=M.textures,O=M.width,K=M.height;let J=i.COLOR_BUFFER_BIT;const te=M.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ae=n.get(M),X=_.length>1;if(X)for(let de=0;de<_.length;de++)t.bindFramebuffer(i.FRAMEBUFFER,ae.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+de,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,ae.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+de,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,ae.__webglMultisampledFramebuffer);const Z=M.texture.mipmaps;Z&&Z.length>0?t.bindFramebuffer(i.DRAW_FRAMEBUFFER,ae.__webglFramebuffer[0]):t.bindFramebuffer(i.DRAW_FRAMEBUFFER,ae.__webglFramebuffer);for(let de=0;de<_.length;de++){if(M.resolveDepthBuffer&&(M.depthBuffer&&(J|=i.DEPTH_BUFFER_BIT),M.stencilBuffer&&M.resolveStencilBuffer&&(J|=i.STENCIL_BUFFER_BIT)),X){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,ae.__webglColorRenderbuffer[de]);const ge=n.get(_[de]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,ge,0)}i.blitFramebuffer(0,0,O,K,0,0,O,K,J,i.NEAREST),l===!0&&(st.length=0,wt.length=0,st.push(i.COLOR_ATTACHMENT0+de),M.depthBuffer&&M.resolveDepthBuffer===!1&&(st.push(te),wt.push(te),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,wt)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,st))}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),X)for(let de=0;de<_.length;de++){t.bindFramebuffer(i.FRAMEBUFFER,ae.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+de,i.RENDERBUFFER,ae.__webglColorRenderbuffer[de]);const ge=n.get(_[de]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,ae.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+de,i.TEXTURE_2D,ge,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,ae.__webglMultisampledFramebuffer)}else if(M.depthBuffer&&M.resolveDepthBuffer===!1&&l){const _=M.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[_])}}}function pt(M){return Math.min(r.maxSamples,M.samples)}function Ge(M){const _=n.get(M);return M.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&_.__useRenderToTexture!==!1}function et(M){const _=a.render.frame;h.get(M)!==_&&(h.set(M,_),M.update())}function ce(M,_){const O=M.colorSpace,K=M.format,J=M.type;return M.isCompressedTexture===!0||M.isVideoTexture===!0||O!==gr&&O!==bn&&(He.getTransfer(O)===Ke?(K!==kt||J!==Ot)&&Re("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Xe("WebGLTextures: Unsupported texture color space:",O)),_}function at(M){return typeof HTMLImageElement<"u"&&M instanceof HTMLImageElement?(c.width=M.naturalWidth||M.width,c.height=M.naturalHeight||M.height):typeof VideoFrame<"u"&&M instanceof VideoFrame?(c.width=M.displayWidth,c.height=M.displayHeight):(c.width=M.width,c.height=M.height),c}this.allocateTextureUnit=z,this.resetTextureUnits=k,this.getTextureUnits=W,this.setTextureUnits=D,this.setTexture2D=j,this.setTexture2DArray=Q,this.setTexture3D=le,this.setTextureCube=ve,this.rebindTextures=nt,this.setupRenderTarget=Be,this.updateRenderTargetMipmap=dt,this.updateMultisampleRenderTarget=L,this.setupDepthRenderbuffer=Ze,this.setupFrameBufferTexture=be,this.useMultisampledRTT=Ge,this.isReversedDepthBuffer=function(){return t.buffers.depth.getReversed()}}function Bp(i,e){function t(n,r=bn){let s;const a=He.getTransfer(r);if(n===Ot)return i.UNSIGNED_BYTE;if(n===ta)return i.UNSIGNED_SHORT_4_4_4_4;if(n===na)return i.UNSIGNED_SHORT_5_5_5_1;if(n===Oo)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===Bo)return i.UNSIGNED_INT_10F_11F_11F_REV;if(n===No)return i.BYTE;if(n===Fo)return i.SHORT;if(n===Ui)return i.UNSIGNED_SHORT;if(n===ea)return i.INT;if(n===tn)return i.UNSIGNED_INT;if(n===Ht)return i.FLOAT;if(n===pn)return i.HALF_FLOAT;if(n===zo)return i.ALPHA;if(n===Go)return i.RGB;if(n===kt)return i.RGBA;if(n===mn)return i.DEPTH_COMPONENT;if(n===Bn)return i.DEPTH_STENCIL;if(n===ia)return i.RED;if(n===ra)return i.RED_INTEGER;if(n===Vn)return i.RG;if(n===sa)return i.RG_INTEGER;if(n===aa)return i.RGBA_INTEGER;if(n===ur||n===fr||n===hr||n===dr)if(a===Ke)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(n===ur)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===fr)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===hr)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===dr)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(n===ur)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===fr)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===hr)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===dr)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===vs||n===Ms||n===Ss||n===Es)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(n===vs)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===Ms)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===Ss)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===Es)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===Ts||n===ys||n===bs||n===As||n===Rs||n===mr||n===ws)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(n===Ts||n===ys)return a===Ke?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(n===bs)return a===Ke?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC;if(n===As)return s.COMPRESSED_R11_EAC;if(n===Rs)return s.COMPRESSED_SIGNED_R11_EAC;if(n===mr)return s.COMPRESSED_RG11_EAC;if(n===ws)return s.COMPRESSED_SIGNED_RG11_EAC}else return null;if(n===Cs||n===Ps||n===Ds||n===Ls||n===Us||n===Is||n===Ns||n===Fs||n===Os||n===Bs||n===zs||n===Gs||n===Vs||n===Hs)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(n===Cs)return a===Ke?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===Ps)return a===Ke?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===Ds)return a===Ke?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===Ls)return a===Ke?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===Us)return a===Ke?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===Is)return a===Ke?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===Ns)return a===Ke?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===Fs)return a===Ke?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===Os)return a===Ke?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===Bs)return a===Ke?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===zs)return a===Ke?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===Gs)return a===Ke?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===Vs)return a===Ke?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===Hs)return a===Ke?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===ks||n===Ws||n===Xs)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(n===ks)return a===Ke?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===Ws)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Xs)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===qs||n===Ys||n===_r||n===Ks)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(n===qs)return s.COMPRESSED_RED_RGTC1_EXT;if(n===Ys)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===_r)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===Ks)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===Ii?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:t}}const zp=`
void main() {
...
}`;class Vp{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){const n=new $o(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=n}}getMesh(e){if(this.texture!==null&&this.mesh===null){const t=e.cameras[0].viewport,n=new nn({vertexShader:zp,fragmentShader:Gp,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new Xt(new Tr(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class Hp extends Hn{constructor(e,t){super();const n=this;let r=null,s=1,a=null,o="local-floor",l=1,c=null,h=null,p=null,u=null,m=null,v=null;const E=typeof XRWebGLBinding<"u",d=new Vp,f={},S=t.getContextAttributes();let A=null,b=null;const w=[],y=[],C=new ke;let g=null;const T=new Ft;T.viewport=new ft;const U=new Ft;U.viewport=new ft;const R=[T,U],N=new jc;let k=null,W=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(Y){let oe=w[Y];return oe===void 0&&(oe=new Fr,w[Y]=oe),oe.getTargetRaySpace()},this.getControllerGrip=function(Y){let oe=w[Y];return oe===void 0&&(oe=new Fr,w[Y]=oe),oe.getGripSpace()},this.getHand=function(Y){let oe=w[Y];return oe===void 0&&(oe=new Fr,w[Y]=oe),oe.getHandSpace()};function D(Y){const oe=y.indexOf(Y.inputSource);if(oe===-1)return;const ee=w[oe];ee!==void 0&&(ee.update(Y.inputSource,Y.frame,c||a),ee.dispatchEvent({type:Y.type,data:Y.inputSource}))}function z(){r.removeEventListener("select",D),r.removeEventListener("selectstart",D),r.removeEventListener("selectend",D),r.removeEventListener("squeeze",D),r.removeEventListener("squeezestart",D),r.removeEventListener("squeezeend",D),r.removeEventListener("end",z),r.removeEventListener("inputsourceschange",H);for(let Y=0;Y<w.length;Y++){const oe=y[Y];oe!==null&&(y[Y]=null,w[Y].disconnect(oe))}k=null,W=null,d.reset();for(const Y in f)delete f[Y];e.setRenderTarget(A),m=null,u=null,p=null,r=null,b=null,we.stop(),n.isPresenting=!1,e.setPixelRatio(g),e.setSize(C.width,C.height,!1),n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(Y){s=Y,n.isPresenting===!0&&Re("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(Y){o=Y,n.isPresenting===!0&&Re("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(Y){c=Y},this.getBaseLayer=function(){return u!==null?u:m},this.getBinding=function(){return p===null&&E&&(p=new XRWebGLBinding(r,t)),p},this.getFrame=function(){return v},this.getSession=function(){return r},this.setSession=async function(Y){if(r=Y,r!==null){if(A=e.getRenderTarget(),r.addEventListener("select",D),r.addEventListener("selectstart",D),r.addEventListener("selectend",D),r.addEventListener("squeeze",D),r.addEventListener("squeezestart",D),r.addEventListener("squeezeend",D),r.addEventListener("end",z),r.addEventListener("inputsourceschange",H),S.xrCompatible!==!0&&await t.makeXRCompatible(),g=e.getPixelRatio(),e.getSize(C),E&&"createProjectionLayer"in XRWebGLBinding.prototype){let ee=null,ye=null,Ce=null;S.depth&&(Ce=S.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,ee=S.stencil?Bn:mn,ye=S.stencil?Ii:tn);const be={colorFormat:t.RGBA8,depthFormat:Ce,scaleFactor:s};p=this.getBinding(),u=p.createProjectionLayer(be),r.updateRenderState({layers:[u]}),e.setPixelRatio(1),e.setSize(u.textureWidth,u.textureHeight,!1),b=new en(u.textureWidth,u.textureHeight,{format:kt,type:Ot,depthTexture:new pi(u.textureWidth,u.textureHeight,ye,void 0,void 0,void 0,void 0,void 0,void 0,ee),stencilBuffer:S.stencil,colorSpace:e.outputColorSpace,samples:S.antialias?4:0,resolveDepthBuffer:u.ignoreDepthValues===!1,resolveStencilBuffer:u.ignoreDepthValues===!1})}else{const ee={antialias:S.antialias,alpha:!0,depth:S.depth,stencil:S.stencil,framebufferScaleFactor:s};m=new XRWebGLLayer(r,t,ee),r.updateRenderState({baseLayer:m}),e.setPixelRatio(1),e.setSize(m.framebufferWidth,m.framebufferHeight,!1),b=new en(m.framebufferWidth,m.framebufferHeight,{format:kt,type:Ot,colorSpace:e.outputColorSpace,stencilBuffer:S.stencil,resolveDepthBuffer:m.ignoreDepthValues===!1,resolveStencilBuffer:m.ignoreDepthValues===!1})}b.isXRRenderTarget=!0,this.setFoveation(l),c=null,a=await r.requestReferenceSpace(o),we.setContext(r),we.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return d.getDepthTexture()};function H(Y){for(let oe=0;oe<Y.removed.length;oe++){const ee=Y.removed[oe],ye=y.indexOf(ee);ye>=0&&(y[ye]=null,w[ye].disconnect(ee))}for(let oe=0;oe<Y.added.length;oe++){const ee=Y.added[oe];let ye=y.indexOf(ee);if(ye===-1){for(let be=0;be<w.length;be++)if(be>=y.length){y.push(ee),ye=be;break}else if(y[be]===null){y[be]=ee,ye=be;break}if(ye===-1)break}const Ce=w[ye];Ce&&Ce.connect(ee)}}const j=new F,Q=new F;function le(Y,oe,ee){j.setFromMatrixPosition(oe.matrixWorld),Q.setFromMatrixPosition(ee.matrixWorld);const ye=j.distanceTo(Q),Ce=oe.projectionMatrix.elements,be=ee.projectionMatrix.elements,rt=Ce[14]/(Ce[10]-1),ze=Ce[14]/(Ce[10]+1),Ze=(Ce[9]+1)/Ce[5],nt=(Ce[9]-1)/Ce[5],Be=(Ce[8]-1)/Ce[0],dt=(be[8]+1)/be[0],st=rt*Be,wt=rt*dt,L=ye/(-Be+dt),pt=L*-Be;if(oe.matrixWorld.decompose(Y.position,Y.quaternion,Y.scale),Y.translateX(pt),Y.translateZ(L),Y.matrixWorld.compose(Y.position,Y.quaternion,Y.scale),Y.matrixWorldInverse.copy(Y.matrixWorld).invert(),Ce[10]===-1)Y.projectionMatrix.copy(oe.projectionMatrix),Y.projectionMatrixInverse.copy(oe.projectionMatrixInverse);else{const Ge=rt+L,et=ze+L,ce=st-pt,at=wt+(ye-pt),M=Ze*ze/et*Ge,_=nt*ze/et*Ge;Y.projectionMatrix.makePerspective(ce,at,M,_,Ge,et),Y.projectionMatrixInverse.copy(Y.projectionMatrix).invert()}}function ve(Y,oe){oe===null?Y.matrixWorld.copy(Y.matrix):Y.matrixWorld.multiplyMatrices(oe.matrixWorld,Y.matrix),Y.matrixWorldInverse.copy(Y.matrixWorld).invert()}this.updateCamera=function(Y){if(r===null)return;let oe=Y.near,ee=Y.far;d.texture!==null&&(d.depthNear>0&&(oe=d.depthNear),d.depthFar>0&&(ee=d.depthFar)),N.near=U.near=T.near=oe,N.far=U.far=T.far=ee,(k!==N.near||W!==N.far)&&(r.updateRenderState({depthNear:N.near,depthFar:N.far}),k=N.near,W=N.far),N.layers.mask=Y.layers.mask|6,T.layers.mask=N.layers.mask&-5,U.layers.mask=N.layers.mask&-3;const ye=Y.parent,Ce=N.cameras;ve(N,ye);for(let be=0;be<Ce.length;be++)ve(Ce[be],ye);Ce.length===2?le(N,T,U):N.projectionMatrix.copy(T.projectionMatrix),pe(Y,N,ye)};function pe(Y,oe,ee){ee===null?Y.matrix.copy(oe.matrixWorld):(Y.matrix.copy(ee.matrixWorld),Y.matrix.invert(),Y.matrix.multiply(oe.matrixWorld)),Y.matrix.decompose(Y.position,Y.quaternion,Y.scale),Y.updateMatrixWorld(!0),Y.projectionMatrix.copy(oe.projectionMatrix),Y.projectionMatrixInverse.copy(oe.projectionMatrixInverse),Y.isPerspectiveCamera&&(Y.fov=Ni*2*Math.atan(1/Y.projectionMatrix.elements[5]),Y.zoom=1)}this.getCamera=function(){return N},this.getFoveation=function(){if(!(u===null&&m===null))return l},this.setFoveation=function(Y){l=Y,u!==null&&(u.fixedFoveation=Y),m!==null&&m.fixedFoveation!==void 0&&(m.fixedFoveation=Y)},this.hasDepthSensing=function(){return d.texture!==null},this.getDepthSensingMesh=function(){return d.getMesh(N)},this.getCameraTexture=function(Y){return f[Y]};let Ae=null;function Fe(Y,oe){if(h=oe.getViewerPose(c||a),v=oe,h!==null){const ee=h.views;m!==null&&(e.setRenderTargetFramebuffer(b,m.framebuffer),e.setRenderTarget(b));let ye=!1;ee.length!==N.cameras.length&&(N.cameras.length=0,ye=!0);for(let ze=0;ze<ee.length;ze++){const Ze=ee[ze];let nt=null;if(m!==null)nt=m.getViewport(Ze);else{const dt=p.getViewSubImage(u,Ze);nt=dt.viewport,ze===0&&(e.setRenderTargetTextures(b,dt.colorTexture,dt.depthStencilTexture),e.setRenderTarget(b))}let Be=R[ze];Be===void 0&&(Be=new Ft,Be.layers.enable(ze),Be.viewport=new ft,R[ze]=Be),Be.matrix.fromArray(Ze.transform.matrix),Be.matrix.decompose(Be.position,Be.quaternion,Be.scale),Be.projectionMatrix.fromArray(Ze.projectionMatrix),Be.projectionMatrixInverse.copy(Be.projectionMatrix).invert(),Be.viewport.set(nt.x,nt.y,nt.width,nt.height),ze===0&&(N.matrix.copy(Be.matrix),N.matrix.decompose(N.position,N.quaternion,N.scale)),ye===!0&&N.cameras.push(Be)}const Ce=r.enabledFeatures;if(Ce&&Ce.includes("depth-sensing")&&r.depthUsage=="gpu-optimized"&&E){p=n.getBinding();const ze=p.getDepthInformation(ee[0]);ze&&ze.isValid&&ze.texture&&d.init(ze,r.renderState)}if(Ce&&Ce.includes("camera-access")&&E){e.state.unbindTexture(),p=n.getBinding();for(let ze=0;ze<ee.length;ze++){const Ze=ee[ze].camera;if(Ze){let nt=f[Ze];nt||(nt=new $o,f[Ze]=nt);const Be=p.getCameraImage(Ze);nt.sourceTexture=Be}}}}for(let ee=0;ee<w.length;ee++){const ye=y[ee],Ce=w[ee];ye!==null&&Ce!==void 0&&Ce.update(ye,oe,c||a)}Ae&&Ae(Y,oe),oe.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:oe}),v=null}const we=new tl;we.setAnimationLoop(Fe),this.setAnimationLoop=function(Y){Ae=Y},this.dispose=function(){}}}const kp=new it,ll=new De;ll.set(-1,0,0,0,1,0,0,0,1);function Wp(i,e){function t(d,f){d.matrixAutoUpdate===!0&&d.updateMatrix(),f.value.copy(d.matrix)}function n(d,f){f.color.getRGB(d.fogColor.value,jo(i)),f.isFog?(d.fogNear.value=f.near,d.fogFar.value=f.far):f.isFogExp2&&(d.fogDensity.value=f.density)}function r(d,f,S,A,b){f.isNodeMaterial?f.uniformsNeedUpdate=!1:f.isMeshBasicMaterial?s(d,f):f.isMeshLambertMaterial?(s(d,f),f.envMap&&(d.envMapIntensity.value=f.envMapIntensity)):f.isMeshToonMaterial?(s(d,f),p(d,f)):f.isMeshPhongMaterial?(s(d,f),h(d,f),f.envMap&&(d.envMapIntensity.value=f.envMapIntensity)):f.isMeshStandardMaterial?(s(d,f),u(d,f),f.isMeshPhysicalMaterial&&m(d,f,b)):f.isMeshMatcapMaterial?(s(d,f),v(d,f)):f.isMeshDepthMaterial?s(d,f):f.isMeshDistanceMaterial?(s(d,f),E(d,f)):f.isMeshNormalMaterial?s(d,f):f.isLineBasicMaterial?(a(d,f),f.isLineDashedMaterial&&o(d,f)):f.isPointsMaterial?l(d,f,S,A):f.isSpriteMaterial?c(d,f):f.isShadowMaterial?(d.color.value.copy(f.color),d.opacity.value=f.opacity):f.isShaderMaterial&&(f.uniformsNeedUpdate=!1)}function s(d,f){d.opacity.value=f.opacity,f.color&&d.diffuse.value.copy(f.color),f.emissive&&d.emissive.value.copy(f.emissive).multiplyScalar(f.emissiveIntensity),f.map&&(d.map.value=f.map,t(f.map,d.mapTransform)),f.alphaMap&&(d.alphaMap.value=f.alphaMap,t(f.alphaMap,d.alphaMapTransform)),f.bumpMap&&(d.bumpMap.value=f.bumpMap,t(f.bumpMap,d.bumpMapTransform),d.bumpScale.value=f.bumpScale,f.side===At&&(d.bumpScale.value*=-1)),f.normalMap&&(d.normalMap.value=f.normalMap,t(f.normalMap,d.normalMapTransform),d.normalScale.value.copy(f.normalScale),f.side===At&&d.normalScale.value.negate()),f.displacementMap&&(d.displacementMap.value=f.displacementMap,t(f.displacementMap,d.displacementMapTransform),d.displacementScale.value=f.displacementScale,d.displacementBias.value=f.displacementBias),f.emissiveMap&&(d.emissiveMap.value=f.emissiveMap,t(f.emissiveMap,d.emissiveMapTransform)),f.specularMap&&(d.specularMap.value=f.specularMap,t(f.specularMap,d.specularMapTransform)),f.alphaTest>0&&(d.alphaTest.value=f.alphaTest);const S=e.get(f),A=S.envMap,b=S.envMapRotation;A&&(d.envMap.value=A,d.envMapRotation.value.setFromMatrix4(kp.makeRotationFromEuler(b)).transpose(),A.isCubeTexture&&A.isRenderTargetTexture===!1&&d.envMapRotation.value.premultiply(ll),d.reflectivity.value=f.reflectivity,d.ior.value=f.ior,d.refractionRatio.value=f.refractionRatio),f.lightMap&&(d.lightMap.value=f.lightMap,d.lightMapIntensity.value=f.lightMapIntensity,t(f.lightMap,d.lightMapTransform)),f.aoMap&&(d.aoMap.value=f.aoMap,d.aoMapIntensity.value=f.aoMapIntensity,t(f.aoMap,d.aoMapTransform))}function a(d,f){d.diffuse.value.copy(f.color),d.opacity.value=f.opacity,f.map&&(d.map.value=f.map,t(f.map,d.mapTransform))}function o(d,f){d.dashSize.value=f.dashSize,d.totalSize.value=f.dashSize+f.gapSize,d.scale.value=f.scale}function l(d,f,S,A){d.diffuse.value.copy(f.color),d.opacity.value=f.opacity,d.size.value=f.size*S,d.scale.value=A*.5,f.map&&(d.map.value=f.map,t(f.map,d.uvTransform)),f.alphaMap&&(d.alphaMap.value=f.alphaMap,t(f.alphaMap,d.alphaMapTransform)),f.alphaTest>0&&(d.alphaTest.value=f.alphaTest)}function c(d,f){d.diffuse.value.copy(f.color),d.opacity.value=f.opacity,d.rotation.value=f.rotation,f.map&&(d.map.value=f.map,t(f.map,d.mapTransform)),f.alphaMap&&(d.alphaMap.value=f.alphaMap,t(f.alphaMap,d.alphaMapTransform)),f.alphaTest>0&&(d.alphaTest.value=f.alphaTest)}function h(d,f){d.specular.value.copy(f.specular),d.shininess.value=Math.max(f.shininess,1e-4)}function p(d,f){f.gradientMap&&(d.gradientMap.value=f.gradientMap)}function u(d,f){d.metalness.value=f.metalness,f.metalnessMap&&(d.metalnessMap.value=f.metalnessMap,t(f.metalnessMap,d.metalnessMapTransform)),d.roughness.value=f.roughness,f.roughnessMap&&(d.roughnessMap.value=f.roughnessMap,t(f.roughnessMap,d.roughnessMapTransform)),f.envMap&&(d.envMapIntensity.value=f.envMapIntensity)}function m(d,f,S){d.ior.value=f.ior,f.sheen>0&&(d.sheenColor.value.copy(f.sheenColor).multiplyScalar(f.sheen),d.sheenRoughness.value=f.sheenRoughness,f.sheenColorMap&&(d.sheenColorMap.value=f.sheenColorMap,t(f.sheenColorMap,d.sheenColorMapTransform)),f.sheenRoughnessMap&&(d.sheenRoughnessMap.value=f.sheenRoughnessMap,t(f.sheenRoughnessMap,d.sheenRoughnessMapTransform))),f.clearcoat>0&&(d.clearcoat.value=f.clearcoat,d.clearcoatRoughness.value=f.clearcoatRoughness,f.clearcoatMap&&(d.clearcoatMap.value=f.clearcoatMap,t(f.clearcoatMap,d.clearcoatMapTransform)),f.clearcoatRoughnessMap&&(d.clearcoatRoughnessMap.value=f.clearcoatRoughnessMap,t(f.clearcoatRoughnessMap,d.clearcoatRoughnessMapTransform)),f.clearcoatNormalMap&&(d.clearcoatNormalMap.value=f.clearcoatNormalMap,t(f.clearcoatNormalMap,d.clearcoatNormalMapTransform),d.clearcoatNormalScale.value.copy(f.clearcoatNormalScale),f.side===At&&d.clearcoatNormalScale.value.negate())),f.dispersion>0&&(d.dispersion.value=f.dispersion),f.iridescence>0&&(d.iridescence.value=f.iridescence,d.iridescenceIOR.value=f.iridescenceIOR,d.iridescenceThicknessMinimum.value=f.iridescenceThicknessRange[0],d.iridescenceThicknessMaximum.value=f.iridescenceThicknessRange[1],f.iridescenceMap&&(d.iridescenceMap.value=f.iridescenceMap,t(f.iridescenceMap,d.iridescenceMapTransform)),f.iridescenceThicknessMap&&(d.iridescenceThicknessMap.value=f.iridescenceThicknessMap,t(f.iridescenceThicknessMap,d.iridescenceThicknessMapTransform))),f.transmission>0&&(d.transmission.value=f.transmission,d.transmissionSamplerMap.value=S.texture,d.transmissionSamplerSize.value.set(S.width,S.height),f.transmissionMap&&(d.transmissionMap.value=f.transmissionMap,t(f.transmissionMap,d.transmissionMapTransform)),d.thickness.value=f.thickness,f.thicknessMap&&(d.thicknessMap.value=f.thicknessMap,t(f.thicknessMap,d.thicknessMapTransform)),d.attenuationDistance.value=f.attenuationDistance,d.attenuationColor.value.copy(f.attenuationColor)),f.anisotropy>0&&(d.anisotropyVector.value.set(f.anisotropy*Math.cos(f.anisotropyRotation),f.anisotropy*Math.sin(f.anisotropyRotation)),f.anisotropyMap&&(d.anisotropyMap.value=f.anisotropyMap,t(f.anisotropyMap,d.anisotropyMapTransform))),d.specularIntensity.value=f.specularIntensity,d.specularColor.value.copy(f.specularColor),f.specularColorMap&&(d.specularColorMap.value=f.specularColorMap,t(f.specularColorMap,d.specularColorMapTransform)),f.specularIntensityMap&&(d.specularIntensityMap.value=f.specularIntensityMap,t(f.specularIntensityMap,d.specularIntensityMapTransform))}function v(d,f){f.matcap&&(d.matcap.value=f.matcap)}function E(d,f){const S=e.get(f).light;d.referencePosition.value.setFromMatrixPosition(S.matrixWorld),d.nearDistance.value=S.shadow.camera.near,d.farDistance.value=S.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:r}}function Xp(i,e,t,n){let r={},s={},a=[];const o=i.getParameter(i.MAX_UNIFORM_BUFFER_BINDINGS);function l(S,A){const b=A.program;n.uniformBlockBinding(S,b)}function c(S,A){let b=r[S.id];b===void 0&&(v(S),b=h(S),r[S.id]=b,S.addEventListener("dispose",d));const w=A.program;n.updateUBOMapping(S,w);const y=e.render.frame;s[S.id]!==y&&(u(S),s[S.id]=y)}function h(S){const A=p();S.__bindingPointIndex=A;const b=i.createBuffer(),w=S.__size,y=S.usage;return i.bindBuffer(i.UNIFORM_BUFFER,b),i.bufferData(i.UNIFORM_BUFFER,w,y),i.bindBuffer(i.UNIFORM_BUFFER,null),i.bindBufferBase(i.UNIFORM_BUFFER,A,b),b}function p(){for(let S=0;S<o;S++)if(a.indexOf(S)===-1)return a.push(S),S;return Xe("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function u(S){const A=r[S.id],b=S.uniforms,w=S.__cache;i.bindBuffer(i.UNIFORM_BUFFER,A);for(let y=0,C=b.length;y<C;y++){const g=Array.isArray(b[y])?b[y]:[b[y]];for(let T=0,U=g.length;T<U;T++){const R=g[T];if(m(R,y,T,w)===!0){const N=R.__offset,k=Array.isArray(R.value)?R.value:[R.value];let W=0;for(let D=0;D<k.length;D++){const z=k[D],H=E(z);typeof z=="number"||typeof z=="boolean"?(R.__data[0]=z,i.bufferSubData(i.UNIFORM_BUFFER,N+W,R.__data)):z.isMatrix3?(R.__data[0]=z.elements[0],R.__data[1]=z.elements[1],R.__data[2]=z.elements[2],R.__data[3]=0,R.__data[4]=z.elements[3],R.__data[5]=z.elements[4],R.__data[6]=z.elements[5],R.__data[7]=0,R.__data[8]=z.elements[6],R.__data[9]=z.elements[7],R.__data[10]=z.elements[8],R.__data[11]=0):ArrayBuffer.isView(z)?R.__data.set(new z.constructor(z.buffer,z.byteOffset,R.__data.length)):(z.toArray(R.__data,W),W+=H.storage/Float32Array.BYTES_PER_ELEMENT)}i.bufferSubData(i.UNIFORM_BUFFER,N,R.__data)}}}i.bindBuffer(i.UNIFORM_BUFFER,null)}function m(S,A,b,w){const y=S.value,C=A+"_"+b;if(w[C]===void 0)return typeof y=="number"||typeof y=="boolean"?w[C]=y:ArrayBuffer.isView(y)?w[C]=y.slice():w[C]=y.clone(),!0;{const g=w[C];if(typeof y=="number"||typeof y=="boolean"){if(g!==y)return w[C]=y,!0}else{if(ArrayBuffer.isView(y))return!0;if(g.equals(y)===!1)return g.copy(y),!0}}return!1}function v(S){const A=S.uniforms;let b=0;const w=16;for(let C=0,g=A.length;C<g;C++){const T=Array.isArray(A[C])?A[C]:[A[C]];for(let U=0,R=T.length;U<R;U++){const N=T[U],k=Array.isArray(N.value)?N.value:[N.value];for(let W=0,D=k.length;W<D;W++){const z=k[W],H=E(z),j=b%w,Q=j%H.boundary,le=j+Q;b+=Q,le!==0&&w-le<H.storage&&(b+=w-le),N.__data=new Float32Array(H.storage/Float32Array.BYTES_PER_ELEMENT),N.__offset=b,b+=H.storage}}}const y=b%w;return y>0&&(b+=w-y),S.__size=b,S.__cache={},this}function E(S){const A={boundary:0,storage:0};return typeof S=="number"||typeof S=="boolean"?(A.boundary=4,A.storage=4):S.isVector2?(A.boundary=8,A.storage=8):S.isVector3||S.isColor?(A.boundary=16,A.storage=12):S.isVector4?(A.boundary=16,A.storage=16):S.isMatrix3?(A.boundary=48,A.storage=48):S.isMatrix4?(A.boundary=64,A.storage=64):S.isTexture?Re("WebGLRenderer: Texture samplers can not be part of an uniforms group."):ArrayBuffer.isView(S)?(A.boundary=16,A.storage=S.byteLength):Re("WebGLRenderer: Unsupported uniform value type.",S),A}function d(S){const A=S.target;A.removeEventListener("dispose",d);const b=a.indexOf(A.__bindingPointIndex);a.splice(b,1),i.deleteBuffer(r[A.id]),delete r[A.id],delete s[A.id]}function f(){for(const S in r)i.deleteBuffer(r[S]);a=[],r={},s={}}return{bind:l,update:c,dispose:f}}const qp=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]);let $t=null;function Yp(){return $t===null&&($t=new Yo(qp,16,16,Vn,pn),$t.name="DFG_LUT",$t.minFilter=Et,$t.magFilter=Et,$t.wrapS=fn,$t.wrapT=fn,$t.generateMipmaps=!1,$t.needsUpdate=!0),$t}class Kp{constructor(e={}){const{canvas:t=Jl(),context:n=null,depth:r=!0,stencil:s=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:h="default",failIfMajorPerformanceCaveat:p=!1,reversedDepthBuffer:u=!1,outputBufferType:m=Ot}=e;this.isWebGLRenderer=!0;let v;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");v=n.getContextAttributes().alpha}else v=a;const E=m,d=new Set([aa,sa,ra]),f=new Set([Ot,tn,Ui,Ii,ta,na]),S=new Uint32Array(4),A=new Int32Array(4),b=new F;let w=null,y=null;const C=[],g=[];let T=null;this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=Qt,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const U=this;let R=!1,N=null;this._outputColorSpace=Nt;let k=0,W=0,D=null,z=-1,H=null;const j=new ft,Q=new ft;let le=null;const ve=new Ye(0);let pe=0,Ae=t.width,Fe=t.height,we=1,Y=null,oe=null;const ee=new ft(0,0,Ae,Fe),ye=new ft(0,0,Ae,Fe);let Ce=!1;const be=new Ko;let rt=!1,ze=!1;const Ze=new it,nt=new F,Be=new ft,dt={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let st=!1;function wt(){return D===null?we:1}let L=n;function pt(x,I){return t.getContext(x,I)}try{const x={alpha:!0,depth:r,stencil:s,antialias:o,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:h,failIfMajorPerformanceCaveat:p};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${Qs}`),t.addEventListener("webglcontextlost",$,!1),t.addEventListener("webglcontextrestored",Se,!1),t.addEventListener("webglcontextcreationerror",Le,!1),L===null){const I="webgl2";if(L=pt(I,x),L===null)throw pt(I)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(x){throw Xe("WebGLRenderer: "+x.message),x}let Ge,et,ce,at,M,_,O,K,J,te,ae,X,Z,de,ge,re,ne,Pe,Ie,qe,P,ie,q;function me(){Ge=new Yh(L),Ge.init(),P=new Bp(L,Ge),et=new zh(L,Ge,e,P),ce=new Fp(L,Ge),et.reversedDepthBuffer&&u&&ce.buffers.depth.setReversed(!0),at=new $h(L),M=new Ep,_=new Op(L,Ge,ce,M,et,P,at),O=new qh(U),K=new Qc(L),ie=new Oh(L,K),J=new Kh(L,K,at,ie),te=new Jh(L,J,K,ie,at),Pe=new jh(L,et,_),ge=new Gh(M),ae=new Sp(U,O,Ge,et,ie,ge),X=new Wp(U,M),Z=new yp,de=new Pp(Ge),ne=new Fh(U,O,ce,te,v,l),re=new Np(U,te,et),q=new Xp(L,at,et,ce),Ie=new Bh(L,Ge,at),qe=new Zh(L,Ge,at),at.programs=ae.programs,U.capabilities=et,U.extensions=Ge,U.properties=M,U.renderLists=Z,U.shadowMap=re,U.state=ce,U.info=at}me(),E!==Ot&&(T=new ed(E,t.width,t.height,r,s));const se=new Hp(U,L);this.xr=se,this.getContext=function(){return L},this.getContextAttributes=function(){return L.getContextAttributes()},this.forceContextLoss=function(){const x=Ge.get("WEBGL_lose_context");x&&x.loseContext()},this.forceContextRestore=function(){const x=Ge.get("WEBGL_lose_context");x&&x.restoreContext()},this.getPixelRatio=function(){return we},this.setPixelRatio=function(x){x!==void 0&&(we=x,this.setSize(Ae,Fe,!1))},this.getSize=function(x){return x.set(Ae,Fe)},this.setSize=function(x,I,V=!0){if(se.isPresenting){Re("WebGLRenderer: Can't change size while VR device is presenting.");return}Ae=x,Fe=I,t.width=Math.floor(x*we),t.height=Math.floor(I*we),V===!0&&(t.style.width=x+"px",t.style.height=I+"px"),T!==null&&T.setSize(t.width,t.height),this.setViewport(0,0,x,I)},this.getDrawingBufferSize=function(x){return x.set(Ae*we,Fe*we).floor()},this.setDrawingBufferSize=function(x,I,V){Ae=x,Fe=I,we=V,t.width=Math.floor(x*V),t.height=Math.floor(I*V),this.setViewport(0,0,x,I)},this.setEffects=function(x){if(E===Ot){Xe("THREE.WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(x){for(let I=0;I<x.length;I++)if(x[I].isOutputPass===!0){Re("THREE.WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}T.setEffects(x||[])},this.getCurrentViewport=function(x){return x.copy(j)},this.getViewport=function(x){return x.copy(ee)},this.setViewport=function(x,I,V,B){x.isVector4?ee.set(x.x,x.y,x.z,x.w):ee.set(x,I,V,B),ce.viewport(j.copy(ee).multiplyScalar(we).round())},this.getScissor=function(x){return x.copy(ye)},this.setScissor=function(x,I,V,B){x.isVector4?ye.set(x.x,x.y,x.z,x.w):ye.set(x,I,V,B),ce.scissor(Q.copy(ye).multiplyScalar(we).round())},this.getScissorTest=function(){return Ce},this.setScissorTest=function(x){ce.setScissorTest(Ce=x)},this.setOpaqueSort=function(x){Y=x},this.setTransparentSort=function(x){oe=x},this.getClearColor=function(x){return x.copy(ne.getClearColor())},this.setClearColor=function(){ne.setClearColor(...arguments)},this.getClearAlpha=function(){return ne.getClearAlpha()},this.setClearAlpha=function(){ne.setClearAlpha(...arguments)},this.clear=function(x=!0,I=!0,V=!0){let B=0;if(x){let G=!1;if(D!==null){const he=D.texture.format;G=d.has(he)}if(G){const he=D.texture.type,xe=f.has(he),fe=ne.getClearColor(),Me=ne.getClearAlpha(),Ee=fe.r,Ue=fe.g,Oe=fe.b;xe?(S[0]=Ee,S[1]=Ue,S[2]=Oe,S[3]=Me,L.clearBufferuiv(L.COLOR,0,S)):(A[0]=Ee,A[1]=Ue,A[2]=Oe,A[3]=Me,L.clearBufferiv(L.COLOR,0,A))}else B|=L.COLOR_BUFFER_BIT}I&&(B|=L.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),V&&(B|=L.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),B!==0&&L.clear(B)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(x){x.setRenderer(this),N=x},this.dispose=function(){t.removeEventListener("webglcontextlost",$,!1),t.removeEventListener("webglcontextrestored",Se,!1),t.removeEventListener("webglcontextcreationerror",Le,!1),ne.dispose(),Z.dispose(),de.dispose(),M.dispose(),O.dispose(),te.dispose(),ie.dispose(),q.dispose(),ae.dispose(),se.dispose(),se.removeEventListener("sessionstart",da),se.removeEventListener("sessionend",pa),Cn.stop()};function $(x){x.preventDefault(),Pa("WebGLRenderer: Context Lost."),R=!0}function Se(){Pa("WebGLRenderer: Context Restored."),R=!1;const x=at.autoReset,I=re.enabled,V=re.autoUpdate,B=re.needsUpdate,G=re.type;me(),at.autoReset=x,re.enabled=I,re.autoUpdate=V,re.needsUpdate=B,re.type=G}function Le(x){Xe("WebGLRenderer: A WebGL context could not be created. Reason: ",x.statusMessage)}function lt(x){const I=x.target;I.removeEventListener("dispose",lt),$e(I)}function $e(x){rn(x),M.remove(x)}function rn(x){const I=M.get(x).programs;I!==void 0&&(I.forEach(function(V){ae.releaseProgram(V)}),x.isShaderMaterial&&ae.releaseShaderCache(x))}this.renderBufferDirect=function(x,I,V,B,G,he){I===null&&(I=dt);const xe=G.isMesh&&G.matrixWorld.determinant()<0,fe=hl(x,I,V,B,G);ce.setMaterial(B,xe);let Me=V.index,Ee=1;if(B.wireframe===!0){if(Me=J.getWireframeAttribute(V),Me===void 0)return;Ee=2}const Ue=V.drawRange,Oe=V.attributes.position;let Te=Ue.start*Ee,je=(Ue.start+Ue.count)*Ee;he!==null&&(Te=Math.max(Te,he.start*Ee),je=Math.min(je,(he.start+he.count)*Ee)),Me!==null?(Te=Math.max(Te,0),je=Math.min(je,Me.count)):Oe!=null&&(Te=Math.max(Te,0),je=Math.min(je,Oe.count));const ct=je-Te;if(ct<0||ct===1/0)return;ie.setup(G,B,fe,V,Me);let ot,Je=Ie;if(Me!==null&&(ot=K.get(Me),Je=qe,Je.setIndex(ot)),G.isMesh)B.wireframe===!0?(ce.setLineWidth(B.wireframeLinewidth*wt()),Je.setMode(L.LINES)):Je.setMode(L.TRIANGLES);else if(G.isLine){let vt=B.linewidth;vt===void 0&&(vt=1),ce.setLineWidth(vt*wt()),G.isLineSegments?Je.setMode(L.LINES):G.isLineLoop?Je.setMode(L.LINE_LOOP):Je.setMode(L.LINE_STRIP)}else G.isPoints?Je.setMode(L.POINTS):G.isSprite&&Je.setMode(L.TRIANGLES);if(G.isBatchedMesh)if(Ge.get("WEBGL_multi_draw"))Je.renderMultiDraw(G._multiDrawStarts,G._multiDrawCounts,G._multiDrawCount);else{const vt=G._multiDrawStarts,_e=G._multiDrawCounts,Ct=G._multiDrawCount,We=Me?K.get(Me).bytesPerElement:1,Ut=M.get(B).currentProgram.getUniforms();for(let Kt=0;Kt<Ct;Kt++)Ut.setValue(L,"_gl_DrawID",Kt),Je.render(vt[Kt]/We,_e[Kt])}else if(G.isInstancedMesh)Je.renderInstances(Te,ct,G.count);else if(V.isInstancedBufferGeometry){const vt=V._maxInstanceCount!==void 0?V._maxInstanceCount:1/0,_e=Math.min(V.instanceCount,vt);Je.renderInstances(Te,ct,_e)}else Je.render(Te,ct)};function Yt(x,I,V){x.transparent===!0&&x.side===un&&x.forceSinglePass===!1?(x.side=At,x.needsUpdate=!0,zi(x,I,V),x.side=Rn,x.needsUpdate=!0,zi(x,I,V),x.side=un):zi(x,I,V)}this.compile=function(x,I,V=null){V===null&&(V=x),y=de.get(V),y.init(I),g.push(y),V.traverseVisible(function(G){G.isLight&&G.layers.test(I.layers)&&(y.pushLight(G),G.castShadow&&y.pushShadow(G))}),x!==V&&x.traverseVisible(function(G){G.isLight&&G.layers.test(I.layers)&&(y.pushLight(G),G.castShadow&&y.pushShadow(G))}),y.setupLights();const B=new Set;return x.traverse(function(G){if(!(G.isMesh||G.isPoints||G.isLine||G.isSprite))return;const he=G.material;if(he)if(Array.isArray(he))for(let xe=0;xe<he.length;xe++){const fe=he[xe];Yt(fe,V,G),B.add(fe)}else Yt(he,V,G),B.add(he)}),y=g.pop(),B},this.compileAsync=function(x,I,V=null){const B=this.compile(x,I,V);return new Promise(G=>{function he(){if(B.forEach(function(xe){M.get(xe).currentProgram.isReady()&&B.delete(xe)}),B.size===0){G(x);return}setTimeout(he,10)}Ge.get("KHR_parallel_shader_compile")!==null?he():setTimeout(he,10)})};let Ar=null;function ul(x){Ar&&Ar(x)}function da(){Cn.stop()}function pa(){Cn.start()}const Cn=new tl;Cn.setAnimationLoop(ul),typeof self<"u"&&Cn.setContext(self),this.setAnimationLoop=function(x){Ar=x,se.setAnimationLoop(x),x===null?Cn.stop():Cn.start()},se.addEventListener("sessionstart",da),se.addEventListener("sessionend",pa),this.render=function(x,I){if(I!==void 0&&I.isCamera!==!0){Xe("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(R===!0)return;N!==null&&N.renderStart(x,I);const V=se.enabled===!0&&se.isPresenting===!0,B=T!==null&&(D===null||V)&&T.begin(U,D);if(x.matrixWorldAutoUpdate===!0&&x.updateMatrixWorld(),I.parent===null&&I.matrixWorldAutoUpdate===!0&&I.updateMatrixWorld(),se.enabled===!0&&se.isPresenting===!0&&(T===null||T.isCompositing()===!1)&&(se.cameraAutoUpdate===!0&&se.updateCamera(I),I=se.getCamera()),x.isScene===!0&&x.onBeforeRender(U,x,I,D),y=de.get(x,g.length),y.init(I),y.state.textureUnits=_.getTextureUnits(),g.push(y),Ze.multiplyMatrices(I.projectionMatrix,I.matrixWorldInverse),be.setFromProjectionMatrix(Ze,Jt,I.reversedDepth),ze=this.localClippingEnabled,rt=ge.init(this.clippingPlanes,ze),w=Z.get(x,C.length),w.init(),C.push(w),se.enabled===!0&&se.isPresenting===!0){const xe=U.xr.getDepthSensingMesh();xe!==null&&Rr(xe,I,-1/0,U.sortObjects)}Rr(x,I,0,U.sortObjects),w.finish(),U.sortObjects===!0&&w.sort(Y,oe),st=se.enabled===!1||se.isPresenting===!1||se.hasDepthSensing()===!1,st&&ne.addToRenderList(w,x),this.info.render.frame++,rt===!0&&ge.beginShadows();const G=y.state.shadowsArray;if(re.render(G,x,I),rt===!0&&ge.endShadows(),this.info.autoReset===!0&&this.info.reset(),(B&&T.hasRenderPass())===!1){const xe=w.opaque,fe=w.transmissive;if(y.setupLights(),I.isArrayCamera){const Me=I.cameras;if(fe.length>0)for(let Ee=0,Ue=Me.length;Ee<Ue;Ee++){const Oe=Me[Ee];_a(xe,fe,x,Oe)}st&&ne.render(x);for(let Ee=0,Ue=Me.length;Ee<Ue;Ee++){const Oe=Me[Ee];ma(w,x,Oe,Oe.viewport)}}else fe.length>0&&_a(xe,fe,x,I),st&&ne.render(x),ma(w,x,I)}D!==null&&W===0&&(_.updateMultisampleRenderTarget(D),_.updateRenderTargetMipmap(D)),B&&T.end(U),x.isScene===!0&&x.onAfterRender(U,x,I),ie.resetDefaultState(),z=-1,H=null,g.pop(),g.length>0?(y=g[g.length-1],_.setTextureUnits(y.state.textureUnits),rt===!0&&ge.setGlobalState(U.clippingPlanes,y.state.camera)):y=null,C.pop(),C.length>0?w=C[C.length-1]:w=null,N!==null&&N.renderEnd()};function Rr(x,I,V,B){if(x.visible===!1)return;if(x.layers.test(I.layers)){if(x.isGroup)V=x.renderOrder;else if(x.isLOD)x.autoUpdate===!0&&x.update(I);else if(x.isLightProbeGrid)y.pushLightProbeGrid(x);else if(x.isLight)y.pushLight(x),x.castShadow&&y.pushShadow(x);else if(x.isSprite){if(!x.frustumCulled||be.intersectsSprite(x)){B&&Be.setFromMatrixPosition(x.matrixWorld).applyMatrix4(Ze);const xe=te.update(x),fe=x.material;fe.visible&&w.push(x,xe,fe,V,Be.z,null)}}else if((x.isMesh||x.isLine||x.isPoints)&&(!x.frustumCulled||be.intersectsObject(x))){const xe=te.update(x),fe=x.material;if(B&&(x.boundingSphere!==void 0?(x.boundingSphere===null&&x.computeBoundingSphere(),Be.copy(x.boundingSphere.center)):(xe.boundingSphere===null&&xe.computeBoundingSphere(),Be.copy(xe.boundingSphere.center)),Be.applyMatrix4(x.matrixWorld).applyMatrix4(Ze)),Array.isArray(fe)){const Me=xe.groups;for(let Ee=0,Ue=Me.length;Ee<Ue;Ee++){const Oe=Me[Ee],Te=fe[Oe.materialIndex];Te&&Te.visible&&w.push(x,xe,Te,V,Be.z,Oe)}}else fe.visible&&w.push(x,xe,fe,V,Be.z,null)}}const he=x.children;for(let xe=0,fe=he.length;xe<fe;xe++)Rr(he[xe],I,V,B)}function ma(x,I,V,B){const{opaque:G,transmissive:he,transparent:xe}=x;y.setupLightsView(V),rt===!0&&ge.setGlobalState(U.clippingPlanes,V),B&&ce.viewport(j.copy(B)),G.length>0&&Bi(G,I,V),he.length>0&&Bi(he,I,V),xe.length>0&&Bi(xe,I,V),ce.buffers.depth.setTest(!0),ce.buffers.depth.setMask(!0),ce.buffers.color.setMask(!0),ce.setPolygonOffset(!1)}function _a(x,I,V,B){if((V.isScene===!0?V.overrideMaterial:null)!==null)return;if(y.state.transmissionRenderTarget[B.id]===void 0){const Te=Ge.has("EXT_color_buffer_half_float")||Ge.has("EXT_color_buffer_float");y.state.transmissionRenderTarget[B.id]=new en(1,1,{generateMipmaps:!0,type:Te?pn:Ot,minFilter:On,samples:Math.max(4,et.samples),stencilBuffer:s,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:He.workingColorSpace})}const he=y.state.transmissionRenderTarget[B.id],xe=B.viewport||j;he.setSize(xe.z*U.transmissionResolutionScale,xe.w*U.transmissionResolutionScale);const fe=U.getRenderTarget(),Me=U.getActiveCubeFace(),Ee=U.getActiveMipmapLevel();U.setRenderTarget(he),U.getClearColor(ve),pe=U.getClearAlpha(),pe<1&&U.setClearColor(16777215,.5),U.clear(),st&&ne.render(V);const Ue=U.toneMapping;U.toneMapping=Qt;const Oe=B.viewport;if(B.viewport!==void 0&&(B.viewport=void 0),y.setupLightsView(B),rt===!0&&ge.setGlobalState(U.clippingPlanes,B),Bi(x,V,B),_.updateMultisampleRenderTarget(he),_.updateRenderTargetMipmap(he),Ge.has("WEBGL_multisampled_render_to_texture")===!1){let Te=!1;for(let je=0,ct=I.length;je<ct;je++){const ot=I[je],{object:Je,geometry:vt,material:_e,group:Ct}=ot;if(_e.side===un&&Je.layers.test(B.layers)){const We=_e.side;_e.side=At,_e.needsUpdate=!0,ga(Je,V,B,vt,_e,Ct),_e.side=We,_e.needsUpdate=!0,Te=!0}}Te===!0&&(_.updateMultisampleRenderTarget(he),_.updateRenderTargetMipmap(he))}U.setRenderTarget(fe,Me,Ee),U.setClearColor(ve,pe),Oe!==void 0&&(B.viewport=Oe),U.toneMapping=Ue}function Bi(x,I,V){const B=I.isScene===!0?I.overrideMaterial:null;for(let G=0,he=x.length;G<he;G++){const xe=x[G],{object:fe,geometry:Me,group:Ee}=xe;let Ue=xe.material;Ue.allowOverride===!0&&B!==null&&(Ue=B),fe.layers.test(V.layers)&&ga(fe,I,V,Me,Ue,Ee)}}function ga(x,I,V,B,G,he){x.onBeforeRender(U,I,V,B,G,he),x.modelViewMatrix.multiplyMatrices(V.matrixWorldInverse,x.matrixWorld),x.normalMatrix.getNormalMatrix(x.modelViewMatrix),G.onBeforeRender(U,I,V,B,x,he),G.transparent===!0&&G.side===un&&G.forceSinglePass===!1?(G.side=At,G.needsUpdate=!0,U.renderBufferDirect(V,I,B,G,x,he),G.side=Rn,G.needsUpdate=!0,U.renderBufferDirect(V,I,B,G,x,he),G.side=un):U.renderBufferDirect(V,I,B,G,x,he),x.onAfterRender(U,I,V,B,G,he)}function zi(x,I,V){I.isScene!==!0&&(I=dt);const B=M.get(x),G=y.state.lights,he=y.state.shadowsArray,xe=G.state.version,fe=ae.getParameters(x,G.state,he,I,V,y.state.lightProbeGridArray),Me=ae.getProgramCacheKey(fe);let Ee=B.programs;B.environment=x.isMeshStandardMaterial||x.isMeshLambertMaterial||x.isMeshPhongMaterial?I.environment:null,B.fog=I.fog;const Ue=x.isMeshStandardMaterial||x.isMeshLambertMaterial&&!x.envMap||x.isMeshPhongMaterial&&!x.envMap;B.envMap=O.get(x.envMap||B.environment,Ue),B.envMapRotation=B.environment!==null&&x.envMap===null?I.environmentRotation:x.envMapRotation,Ee===void 0&&(x.addEventListener("dispose",lt),Ee=new Map,B.programs=Ee);let Oe=Ee.get(Me);if(Oe!==void 0){if(B.currentProgram===Oe&&B.lightsStateVersion===xe)return va(x,fe),Oe}else fe.uniforms=ae.getUniforms(x),N!==null&&x.isNodeMaterial&&N.build(x,V,fe),x.onBeforeCompile(fe,U),Oe=ae.acquireProgram(fe,Me),Ee.set(Me,Oe),B.uniforms=fe.uniforms;const Te=B.uniforms;return(!x.isShaderMaterial&&!x.isRawShaderMaterial||x.clipping===!0)&&(Te.clippingPlanes=ge.uniform),va(x,fe),B.needsLights=pl(x),B.lightsStateVersion=xe,B.needsLights&&(Te.ambientLightColor.value=G.state.ambient,Te.lightProbe.value=G.state.probe,Te.directionalLights.value=G.state.directional,Te.directionalLightShadows.value=G.state.directionalShadow,Te.spotLights.value=G.state.spot,Te.spotLightShadows.value=G.state.spotShadow,Te.rectAreaLights.value=G.state.rectArea,Te.ltc_1.value=G.state.rectAreaLTC1,Te.ltc_2.value=G.state.rectAreaLTC2,Te.pointLights.value=G.state.point,Te.pointLightShadows.value=G.state.pointShadow,Te.hemisphereLights.value=G.state.hemi,Te.directionalShadowMatrix.value=G.state.directionalShadowMatrix,Te.spotLightMatrix.value=G.state.spotLightMatrix,Te.spotLightMap.value=G.state.spotLightMap,Te.pointShadowMatrix.value=G.state.pointShadowMatrix),B.lightProbeGrid=y.state.lightProbeGridArray.length>0,B.currentProgram=Oe,B.uniformsList=null,Oe}function xa(x){if(x.uniformsList===null){const I=x.currentProgram.getUniforms();x.uniformsList=pr.seqWithValue(I.seq,x.uniforms)}return x.uniformsList}function va(x,I){const V=M.get(x);V.outputColorSpace=I.outputColorSpace,V.batching=I.batching,V.batchingColor=I.batchingColor,V.instancing=I.instancing,V.instancingColor=I.instancingColor,V.instancingMorph=I.instancingMorph,V.skinning=I.skinning,V.morphTargets=I.morphTargets,V.morphNormals=I.morphNormals,V.morphColors=I.morphColors,V.morphTargetsCount=I.morphTargetsCount,V.numClippingPlanes=I.numClippingPlanes,V.numIntersection=I.numClipIntersection,V.vertexAlphas=I.vertexAlphas,V.vertexTangents=I.vertexTangents,V.toneMapping=I.toneMapping}function fl(x,I){if(x.length===0)return null;if(x.length===1)return x[0].texture!==null?x[0]:null;b.setFromMatrixPosition(I.matrixWorld);for(let V=0,B=x.length;V<B;V++){const G=x[V];if(G.texture!==null&&G.boundingBox.containsPoint(b))return G}return null}function hl(x,I,V,B,G){I.isScene!==!0&&(I=dt),_.resetTextureUnits();const he=I.fog,xe=B.isMeshStandardMaterial||B.isMeshLambertMaterial||B.isMeshPhongMaterial?I.environment:null,fe=D===null?U.outputColorSpace:D.isXRRenderTarget===!0?D.texture.colorSpace:He.workingColorSpace,Me=B.isMeshStandardMaterial||B.isMeshLambertMaterial&&!B.envMap||B.isMeshPhongMaterial&&!B.envMap,Ee=O.get(B.envMap||xe,Me),Ue=B.vertexColors===!0&&!!V.attributes.color&&V.attributes.color.itemSize===4,Oe=!!V.attributes.tangent&&(!!B.normalMap||B.anisotropy>0),Te=!!V.morphAttributes.position,je=!!V.morphAttributes.normal,ct=!!V.morphAttributes.color;let ot=Qt;B.toneMapped&&(D===null||D.isXRRenderTarget===!0)&&(ot=U.toneMapping);const Je=V.morphAttributes.position||V.morphAttributes.normal||V.morphAttributes.color,vt=Je!==void 0?Je.length:0,_e=M.get(B),Ct=y.state.lights;if(rt===!0&&(ze===!0||x!==H)){const tt=x===H&&B.id===z;ge.setState(B,x,tt)}let We=!1;B.version===_e.__version?(_e.needsLights&&_e.lightsStateVersion!==Ct.state.version||_e.outputColorSpace!==fe||G.isBatchedMesh&&_e.batching===!1||!G.isBatchedMesh&&_e.batching===!0||G.isBatchedMesh&&_e.batchingColor===!0&&G.colorTexture===null||G.isBatchedMesh&&_e.batchingColor===!1&&G.colorTexture!==null||G.isInstancedMesh&&_e.instancing===!1||!G.isInstancedMesh&&_e.instancing===!0||G.isSkinnedMesh&&_e.skinning===!1||!G.isSkinnedMesh&&_e.skinning===!0||G.isInstancedMesh&&_e.instancingColor===!0&&G.instanceColor===null||G.isInstancedMesh&&_e.instancingColor===!1&&G.instanceColor!==null||G.isInstancedMesh&&_e.instancingMorph===!0&&G.morphTexture===null||G.isInstancedMesh&&_e.instancingMorph===!1&&G.morphTexture!==null||_e.envMap!==Ee||B.fog===!0&&_e.fog!==he||_e.numClippingPlanes!==void 0&&(_e.numClippingPlanes!==ge.numPlanes||_e.numIntersection!==ge.numIntersection)||_e.vertexAlphas!==Ue||_e.vertexTangents!==Oe||_e.morphTargets!==Te||_e.morphNormals!==je||_e.morphColors!==ct||_e.toneMapping!==ot||_e.morphTargetsCount!==vt||!!_e.lightProbeGrid!=y.state.lightProbeGridArray.length>0)&&(We=!0):(We=!0,_e.__version=B.version);let Ut=_e.currentProgram;We===!0&&(Ut=zi(B,I,G),N&&B.isNodeMaterial&&N.onUpdateProgram(B,Ut,_e));let Kt=!1,_n=!1,Xn=!1;const Qe=Ut.getUniforms(),ut=_e.uniforms;if(ce.useProgram(Ut.program)&&(Kt=!0,_n=!0,Xn=!0),B.id!==z&&(z=B.id,_n=!0),_e.needsLights){const tt=fl(y.state.lightProbeGridArray,G);_e.lightProbeGrid!==tt&&(_e.lightProbeGrid=tt,_n=!0)}if(Kt||H!==x){ce.buffers.depth.getReversed()&&x.reversedDepth!==!0&&(x._reversedDepth=!0,x.updateProjectionMatrix()),Qe.setValue(L,"projectionMatrix",x.projectionMatrix),Qe.setValue(L,"viewMatrix",x.matrixWorldInverse);const xn=Qe.map.cameraPosition;xn!==void 0&&xn.setValue(L,nt.setFromMatrixPosition(x.matrixWorld)),et.logarithmicDepthBuffer&&Qe.setValue(L,"logDepthBufFC",2/(Math.log(x.far+1)/Math.LN2)),(B.isMeshPhongMaterial||B.isMeshToonMaterial||B.isMeshLambertMaterial||B.isMeshBasicMaterial||B.isMeshStandardMaterial||B.isShaderMaterial)&&Qe.setValue(L,"isOrthographic",x.isOrthographicCamera===!0),H!==x&&(H=x,_n=!0,Xn=!0)}if(_e.needsLights&&(Ct.state.directionalShadowMap.length>0&&Qe.setValue(L,"directionalShadowMap",Ct.state.directionalShadowMap,_),Ct.state.spotShadowMap.length>0&&Qe.setValue(L,"spotShadowMap",Ct.state.spotShadowMap,_),Ct.state.pointShadowMap.length>0&&Qe.setValue(L,"pointShadowMap",Ct.state.pointShadowMap,_)),G.isSkinnedMesh){Qe.setOptional(L,G,"bindMatrix"),Qe.setOptional(L,G,"bindMatrixInverse");const tt=G.skeleton;tt&&(tt.boneTexture===null&&tt.computeBoneTexture(),Qe.setValue(L,"boneTexture",tt.boneTexture,_))}G.isBatchedMesh&&(Qe.setOptional(L,G,"batchingTexture"),Qe.setValue(L,"batchingTexture",G._matricesTexture,_),Qe.setOptional(L,G,"batchingIdTexture"),Qe.setValue(L,"batchingIdTexture",G._indirectTexture,_),Qe.setOptional(L,G,"batchingColorTexture"),G._colorsTexture!==null&&Qe.setValue(L,"batchingColorTexture",G._colorsTexture,_));const gn=V.morphAttributes;if((gn.position!==void 0||gn.normal!==void 0||gn.color!==void 0)&&Pe.update(G,V,Ut),(_n||_e.receiveShadow!==G.receiveShadow)&&(_e.receiveShadow=G.receiveShadow,Qe.setValue(L,"receiveShadow",G.receiveShadow)),(B.isMeshStandardMaterial||B.isMeshLambertMaterial||B.isMeshPhongMaterial)&&B.envMap===null&&I.environment!==null&&(ut.envMapIntensity.value=I.environmentIntensity),ut.dfgLUT!==void 0&&(ut.dfgLUT.value=Yp()),_n){if(Qe.setValue(L,"toneMappingExposure",U.toneMappingExposure),_e.needsLights&&dl(ut,Xn),he&&B.fog===!0&&X.refreshFogUniforms(ut,he),X.refreshMaterialUniforms(ut,B,we,Fe,y.state.transmissionRenderTarget[x.id]),_e.needsLights&&_e.lightProbeGrid){const tt=_e.lightProbeGrid;ut.probesSH.value=tt.texture,ut.probesMin.value.copy(tt.boundingBox.min),ut.probesMax.value.copy(tt.boundingBox.max),ut.probesResolution.value.copy(tt.resolution)}pr.upload(L,xa(_e),ut,_)}if(B.isShaderMaterial&&B.uniformsNeedUpdate===!0&&(pr.upload(L,xa(_e),ut,_),B.uniformsNeedUpdate=!1),B.isSpriteMaterial&&Qe.setValue(L,"center",G.center),Qe.setValue(L,"modelViewMatrix",G.modelViewMatrix),Qe.setValue(L,"normalMatrix",G.normalMatrix),Qe.setValue(L,"modelMatrix",G.matrixWorld),B.uniformsGroups!==void 0){const tt=B.uniformsGroups;for(let xn=0,qn=tt.length;xn<qn;xn++){const Ma=tt[xn];q.update(Ma,Ut),q.bind(Ma,Ut)}}return Ut}function dl(x,I){x.ambientLightColor.needsUpdate=I,x.lightProbe.needsUpdate=I,x.directionalLights.needsUpdate=I,x.directionalLightShadows.needsUpdate=I,x.pointLights.needsUpdate=I,x.pointLightShadows.needsUpdate=I,x.spotLights.needsUpdate=I,x.spotLightShadows.needsUpdate=I,x.rectAreaLights.needsUpdate=I,x.hemisphereLights.needsUpdate=I}function pl(x){return x.isMeshLambertMaterial||x.isMeshToonMaterial||x.isMeshPhongMaterial||x.isMeshStandardMaterial||x.isShadowMaterial||x.isShaderMaterial&&x.lights===!0}this.getActiveCubeFace=function(){return k},this.getActiveMipmapLevel=function(){return W},this.getRenderTarget=function(){return D},this.setRenderTargetTextures=function(x,I,V){const B=M.get(x);B.__autoAllocateDepthBuffer=x.resolveDepthBuffer===!1,B.__autoAllocateDepthBuffer===!1&&(B.__useRenderToTexture=!1),M.get(x.texture).__webglTexture=I,M.get(x.depthTexture).__webglTexture=B.__autoAllocateDepthBuffer?void 0:V,B.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(x,I){const V=M.get(x);V.__webglFramebuffer=I,V.__useDefaultFramebuffer=I===void 0};const ml=L.createFramebuffer();this.setRenderTarget=function(x,I=0,V=0){D=x,k=I,W=V;let B=null,G=!1,he=!1;if(x){const fe=M.get(x);if(fe.__useDefaultFramebuffer!==void 0){ce.bindFramebuffer(L.FRAMEBUFFER,fe.__webglFramebuffer),j.copy(x.viewport),Q.copy(x.scissor),le=x.scissorTest,ce.viewport(j),ce.scissor(Q),ce.setScissorTest(le),z=-1;return}else if(fe.__webglFramebuffer===void 0)_.setupRenderTarget(x);else if(fe.__hasExternalTextures)_.rebindTextures(x,M.get(x.texture).__webglTexture,M.get(x.depthTexture).__webglTexture);else if(x.depthBuffer){const Ue=x.depthTexture;if(fe.__boundDepthTexture!==Ue){if(Ue!==null&&M.has(Ue)&&(x.width!==Ue.image.width||x.height!==Ue.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");_.setupDepthRenderbuffer(x)}}const Me=x.texture;(Me.isData3DTexture||Me.isDataArrayTexture||Me.isCompressedArrayTexture)&&(he=!0);const Ee=M.get(x).__webglFramebuffer;x.isWebGLCubeRenderTarget?(Array.isArray(Ee[I])?B=Ee[I][V]:B=Ee[I],G=!0):x.samples>0&&_.useMultisampledRTT(x)===!1?B=M.get(x).__webglMultisampledFramebuffer:Array.isArray(Ee)?B=Ee[V]:B=Ee,j.copy(x.viewport),Q.copy(x.scissor),le=x.scissorTest}else j.copy(ee).multiplyScalar(we).floor(),Q.copy(ye).multiplyScalar(we).floor(),le=Ce;if(V!==0&&(B=ml),ce.bindFramebuffer(L.FRAMEBUFFER,B)&&ce.drawBuffers(x,B),ce.viewport(j),ce.scissor(Q),ce.setScissorTest(le),G){const fe=M.get(x.texture);L.framebufferTexture2D(L.FRAMEBUFFER,L.COLOR_ATTACHMENT0,L.TEXTURE_CUBE_MAP_POSITIVE_X+I,fe.__webglTexture,V)}else if(he){const fe=I;for(let Me=0;Me<x.textures.length;Me++){const Ee=M.get(x.textures[Me]);L.framebufferTextureLayer(L.FRAMEBUFFER,L.COLOR_ATTACHMENT0+Me,Ee.__webglTexture,V,fe)}}else if(x!==null&&V!==0){const fe=M.get(x.texture);L.framebufferTexture2D(L.FRAMEBUFFER,L.COLOR_ATTACHMENT0,L.TEXTURE_2D,fe.__webglTexture,V)}z=-1},this.readRenderTargetPixels=function(x,I,V,B,G,he,xe,fe=0){if(!(x&&x.isWebGLRenderTarget)){Xe("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Me=M.get(x).__webglFramebuffer;if(x.isWebGLCubeRenderTarget&&xe!==void 0&&(Me=Me[xe]),Me){ce.bindFramebuffer(L.FRAMEBUFFER,Me);try{const Ee=x.textures[fe],Ue=Ee.format,Oe=Ee.type;if(x.textures.length>1&&L.readBuffer(L.COLOR_ATTACHMENT0+fe),!et.textureFormatReadable(Ue)){Xe("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!et.textureTypeReadable(Oe)){Xe("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}I>=0&&I<=x.width-B&&V>=0&&V<=x.height-G&&L.readPixels(I,V,B,G,P.convert(Ue),P.convert(Oe),he)}finally{const Ee=D!==null?M.get(D).__webglFramebuffer:null;ce.bindFramebuffer(L.FRAMEBUFFER,Ee)}}},this.readRenderTargetPixelsAsync=async function(x,I,V,B,G,he,xe,fe=0){if(!(x&&x.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Me=M.get(x).__webglFramebuffer;if(x.isWebGLCubeRenderTarget&&xe!==void 0&&(Me=Me[xe]),Me)if(I>=0&&I<=x.width-B&&V>=0&&V<=x.height-G){ce.bindFramebuffer(L.FRAMEBUFFER,Me);const Ee=x.textures[fe],Ue=Ee.format,Oe=Ee.type;if(x.textures.length>1&&L.readBuffer(L.COLOR_ATTACHMENT0+fe),!et.textureFormatReadable(Ue))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!et.textureTypeReadable(Oe))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const Te=L.createBuffer();L.bindBuffer(L.PIXEL_PACK_BUFFER,Te),L.bufferData(L.PIXEL_PACK_BUFFER,he.byteLength,L.STREAM_READ),L.readPixels(I,V,B,G,P.convert(Ue),P.convert(Oe),0);const je=D!==null?M.get(D).__webglFramebuffer:null;ce.bindFramebuffer(L.FRAMEBUFFER,je);const ct=L.fenceSync(L.SYNC_GPU_COMMANDS_COMPLETE,0);return L.flush(),await Ql(L,ct,4),L.bindBuffer(L.PIXEL_PACK_BUFFER,Te),L.getBufferSubData(L.PIXEL_PACK_BUFFER,0,he),L.deleteBuffer(Te),L.deleteSync(ct),he}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(x,I=null,V=0){const B=Math.pow(2,-V),G=Math.floor(x.image.width*B),he=Math.floor(x.image.height*B),xe=I!==null?I.x:0,fe=I!==null?I.y:0;_.setTexture2D(x,0),L.copyTexSubImage2D(L.TEXTURE_2D,V,0,0,xe,fe,G,he),ce.unbindTexture()};const _l=L.createFramebuffer(),gl=L.createFramebuffer();this.copyTextureToTexture=function(x,I,V=null,B=null,G=0,he=0){let xe,fe,Me,Ee,Ue,Oe,Te,je,ct;const ot=x.isCompressedTexture?x.mipmaps[he]:x.image;if(V!==null)xe=V.max.x-V.min.x,fe=V.max.y-V.min.y,Me=V.isBox3?V.max.z-V.min.z:1,Ee=V.min.x,Ue=V.min.y,Oe=V.isBox3?V.min.z:0;else{const ut=Math.pow(2,-G);xe=Math.floor(ot.width*ut),fe=Math.floor(ot.height*ut),x.isDataArrayTexture?Me=ot.depth:x.isData3DTexture?Me=Math.floor(ot.depth*ut):Me=1,Ee=0,Ue=0,Oe=0}B!==null?(Te=B.x,je=B.y,ct=B.z):(Te=0,je=0,ct=0);const Je=P.convert(I.format),vt=P.convert(I.type);let _e;I.isData3DTexture?(_.setTexture3D(I,0),_e=L.TEXTURE_3D):I.isDataArrayTexture||I.isCompressedArrayTexture?(_.setTexture2DArray(I,0),_e=L.TEXTURE_2D_ARRAY):(_.setTexture2D(I,0),_e=L.TEXTURE_2D),ce.activeTexture(L.TEXTURE0),ce.pixelStorei(L.UNPACK_FLIP_Y_WEBGL,I.flipY),ce.pixelStorei(L.UNPACK_PREMULTIPLY_ALPHA_WEBGL,I.premultiplyAlpha),ce.pixelStorei(L.UNPACK_ALIGNMENT,I.unpackAlignment);const Ct=ce.getParameter(L.UNPACK_ROW_LENGTH),We=ce.getParameter(L.UNPACK_IMAGE_HEIGHT),Ut=ce.getParameter(L.UNPACK_SKIP_PIXELS),Kt=ce.getParameter(L.UNPACK_SKIP_ROWS),_n=ce.getParameter(L.UNPACK_SKIP_IMAGES);ce.pixelStorei(L.UNPACK_ROW_LENGTH,ot.width),ce.pixelStorei(L.UNPACK_IMAGE_HEIGHT,ot.height),ce.pixelStorei(L.UNPACK_SKIP_PIXELS,Ee),ce.pixelStorei(L.UNPACK_SKIP_ROWS,Ue),ce.pixelStorei(L.UNPACK_SKIP_IMAGES,Oe);const Xn=x.isDataArrayTexture||x.isData3DTexture,Qe=I.isDataArrayTexture||I.isData3DTexture;if(x.isDepthTexture){const ut=M.get(x),gn=M.get(I),tt=M.get(ut.__renderTarget),xn=M.get(gn.__renderTarget);ce.bindFramebuffer(L.READ_FRAMEBUFFER,tt.__webglFramebuffer),ce.bindFramebuffer(L.DRAW_FRAMEBUFFER,xn.__webglFramebuffer);for(let qn=0;qn<Me;qn++)Xn&&(L.framebufferTextureLayer(L.READ_FRAMEBUFFER,L.COLOR_ATTACHMENT0,M.get(x).__webglTexture,G,Oe+qn),L.framebufferTextureLayer(L.DRAW_FRAMEBUFFER,L.COLOR_ATTACHMENT0,M.get(I).__webglTexture,he,ct+qn)),L.blitFramebuffer(Ee,Ue,xe,fe,Te,je,xe,fe,L.DEPTH_BUFFER_BIT,L.NEAREST);ce.bindFramebuffer(L.READ_FRAMEBUFFER,null),ce.bindFramebuffer(L.DRAW_FRAMEBUFFER,null)}else if(G!==0||x.isRenderTargetTexture||M.has(x)){const ut=M.get(x),gn=M.get(I);ce.bindFramebuffer(L.READ_FRAMEBUFFER,_l),ce.bindFramebuffer(L.DRAW_FRAMEBUFFER,gl);for(let tt=0;tt<Me;tt++)Xn?L.framebufferTextureLayer(L.READ_FRAMEBUFFER,L.COLOR_ATTACHMENT0,ut.__webglTexture,G,Oe+tt):L.framebufferTexture2D(L.READ_FRAMEBUFFER,L.COLOR_ATTACHMENT0,L.TEXTURE_2D,ut.__webglTexture,G),Qe?L.framebufferTextureLayer(L.DRAW_FRAMEBUFFER,L.COLOR_ATTACHMENT0,gn.__webglTexture,he,ct+tt):L.framebufferTexture2D(L.DRAW_FRAMEBUFFER,L.COLOR_ATTACHMENT0,L.TEXTURE_2D,gn.__webglTexture,he),G!==0?L.blitFramebuffer(Ee,Ue,xe,fe,Te,je,xe,fe,L.COLOR_BUFFER_BIT,L.NEAREST):Qe?L.copyTexSubImage3D(_e,he,Te,je,ct+tt,Ee,Ue,xe,fe):L.copyTexSubImage2D(_e,he,Te,je,Ee,Ue,xe,fe);ce.bindFramebuffer(L.READ_FRAMEBUFFER,null),ce.bindFramebuffer(L.DRAW_FRAMEBUFFER,null)}else Qe?x.isDataTexture||x.isData3DTexture?L.texSubImage3D(_e,he,Te,je,ct,xe,fe,Me,Je,vt,ot.data):I.isCompressedArrayTexture?L.compressedTexSubImage3D(_e,he,Te,je,ct,xe,fe,Me,Je,ot.data):L.texSubImage3D(_e,he,Te,je,ct,xe,fe,Me,Je,vt,ot):x.isDataTexture?L.texSubImage2D(L.TEXTURE_2D,he,Te,je,xe,fe,Je,vt,ot.data):x.isCompressedTexture?L.compressedTexSubImage2D(L.TEXTURE_2D,he,Te,je,ot.width,ot.height,Je,ot.data):L.texSubImage2D(L.TEXTURE_2D,he,Te,je,xe,fe,Je,vt,ot);ce.pixelStorei(L.UNPACK_ROW_LENGTH,Ct),ce.pixelStorei(L.UNPACK_IMAGE_HEIGHT,We),ce.pixelStorei(L.UNPACK_SKIP_PIXELS,Ut),ce.pixelStorei(L.UNPACK_SKIP_ROWS,Kt),ce.pixelStorei(L.UNPACK_SKIP_IMAGES,_n),he===0&&I.generateMipmaps&&L.generateMipmap(_e),ce.unbindTexture()},this.initRenderTarget=function(x){M.get(x).__webglFramebuffer===void 0&&_.setupRenderTarget(x)},this.initTexture=function(x){x.isCubeTexture?_.setTextureCube(x,0):x.isData3DTexture?_.setTexture3D(x,0):x.isDataArrayTexture||x.isCompressedArrayTexture?_.setTexture2DArray(x,0):_.setTexture2D(x,0),ce.unbindTexture()},this.resetState=function(){k=0,W=0,D=null,ce.reset(),ie.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return Jt}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const t=this.getContext();t.drawingBufferColorSpace=He._getDrawingBufferColorSpace(e),t.unpackColorSpace=He._getUnpackColorSpace()}}let yo=!1;function Zp(){yo||(bo.registerPlugin(os),yo=!0)}function $p(){return window.matchMedia("(prefers-reduced-motion: reduce)").matches}function Pi(i){return Math.min(1,Math.max(0,i))}function zn(i,e,t){const n=Pi((t-i)/(e-i));return n*n*(3-2*n)}function jp(i){let e=i;return()=>{e|=0,e=e+1831565813|0;let t=Math.imul(e^e>>>15,1|e);return t=t+Math.imul(t^t>>>7,61|t)^t,((t^t>>>14)>>>0)/4294967296}}const Jp=12354592,Qp=14068306,em=14276301,tm=9330449,nm=10315796,im=4670525,rm=new Ye(1052688),sm=new Ye(15921903),fi=Math.PI*2,_i=[new F(0,.82,0),new F(-.72,-.42,.52),new F(.72,-.42,.52),new F(0,-.42,-.82)],Js=[[0,1],[0,2],[0,3],[1,2],[2,3],[3,1]];function am(i,e){const t=Math.cos(e),n=Math.sin(e),r=i.x*t-i.z*n,s=i.x*n+i.z*t;return i.x=r,i.z=s,i}function cl(i,e){const t=i()*fi,n=i()*2-1,r=Math.sqrt(Math.max(0,1-n*n))*e;return new F(Math.cos(t)*r,n*e,Math.sin(t)*r)}function om(i,e,t){const n=i()*fi,r=i()*2-1,s=e%6===0?.9+i()*.13:Math.cbrt(i()),a=Math.sqrt(Math.max(0,1-r*r)),o=.92+Math.sin(n*3+r*2.8)*.08,l=new F(Math.cos(n)*a*s*1.5*o,r*s*1.16,Math.sin(n)*a*s*.98*(1.02-(o-.92)*.42)),c=l.y*.42+Math.sin(s*Math.PI)*.18;if(am(l,c),e%9===0){const h=_i[e%_i.length].clone().multiplyScalar(1.3);l.lerp(h,.22+i()*.22)}return e>t*.68&&(l.x+=.14,l.y*=.92),l}function lm(i,e,t){const n=e/Math.max(1,t-1),r=Math.sin(n*fi*1.55),s=Math.cos(n*fi*2.1);return new F((i()-.5)*5.8+r*.5,(i()-.5)*2.9+Math.sin(n*fi*4.2)*.34,(i()-.5)*2.15+s*.62)}function cm(i,e){if(e%5===0)return cl(i,.36+i()*.42);const t=Js[e%Js.length],n=_i[t[0]],r=_i[t[1]];return n.clone().lerp(r,i()).multiplyScalar(.94)}function um(i,e){const t=[],n=new F(0,1,0),r=new F,s=new F,a=new F,o=new kn,l=new it,c=new F(1,1,1);Js.forEach(([p,u])=>{const m=_i[p].clone().multiplyScalar(i),v=_i[u].clone().multiplyScalar(i);r.copy(v).sub(m);const E=r.length();s.copy(m).add(v).multiplyScalar(.5),o.setFromUnitVectors(n,r.normalize()),l.compose(s,o,c);const d=new ha(e,e,E,4,1,!1),f=d.getAttribute("position"),S=d.getIndex();if(S)for(let A=0;A<S.count;A+=1)a.fromBufferAttribute(f,S.getX(A)),a.applyMatrix4(l),t.push(a.x,a.y,a.z);else for(let A=0;A<f.count;A+=1)a.fromBufferAttribute(f,A),a.applyMatrix4(l),t.push(a.x,a.y,a.z);d.dispose()});const h=new qt;return h.setAttribute("position",new Lt(t,3)),h.computeBoundingSphere(),h}function fm(i,e){const t=[];for(let n=0;n<i;n+=1){const r=om(e,n,i),s=cl(e,2.7+e()*2.1);s.x+=(e()-.5)*1.1,s.y+=(e()-.5)*.62,t.push({scatter:s,volume:r,field:lm(e,n,i),logo:cm(e,n),rotation:new wn(e()*Math.PI,e()*Math.PI,e()*Math.PI),phase:e()*fi,scale:.62+e()*1.1,depth:.35+e()*.95,pull:.52+e()*.72})}return t}function ss(i,e,t,n,r,s,a){const o=um(s,a),l=new fa({color:t,transparent:!0,opacity:r,depthWrite:!1,toneMapped:!1}),c=new Bc(o,l,i);return c.instanceMatrix.setUsage($l),c.frustumCulled=!1,{mesh:c,material:l,seeds:fm(i,e),baseOpacity:r,heroColor:new Ye(t),paperColor:new Ye(n)}}function as(i,e,t,n,r,s,a,o){const l=zn(.06,.38,n),c=zn(.64,.9,n),h=zn(.07,.2,n),p=o?0:1-c*.58,u=new F,m=s.position.x,v=s.position.y,E=o?0:s.strength*(1-c*.36),d=.86+s.speed*.5+l*.1,f=d*d;for(let b=0;b<i.seeds.length;b+=1){const w=i.seeds[b];u.copy(w.volume).lerp(w.field,l).lerp(w.logo,c),a.position.copy(w.scatter).lerp(u,t);const y=Math.sin(e*.58+w.phase)*.032*p;a.position.x+=y+r.x*.16*w.depth*(1-c*.55),a.position.y+=Math.cos(e*.43+w.phase)*.024*p,a.position.z+=r.y*.14*w.depth;let C=0;if(E>.002){const g=m-a.position.x,T=v-a.position.y,U=Math.sin(w.phase+e*.72)*.42-a.position.z,R=g*g+T*T*1.22+a.position.z*a.position.z*.12,N=Math.sqrt(R),k=Math.exp(-R/f)*E*w.pull,W=Math.exp(-R/(f*3.2))*(1-zn(d*.92,d*1.95,N))*E*.08,D=k+W,z=Math.sin(e*.72+w.phase)*k*.07;C=Math.min(1,k*.72+W*.92),a.position.x+=g*D*.46-T*z,a.position.y+=T*D*.4+g*z*.68,a.position.z+=U*D*.2+Math.sin(e+w.phase)*k*.08}a.rotation.set(w.rotation.x+e*.045*p+n*.7,w.rotation.y+e*.058*p+w.phase*.42,w.rotation.z+e*.034*p),a.scale.setScalar(w.scale*(.7+t*.34+c*.18)*(1+C*.055)),a.updateMatrix(),i.mesh.setMatrixAt(b,a.matrix)}i.material.color.lerpColors(i.heroColor,i.paperColor,h);const S=1-h*.24,A=i.baseOpacity*(.52+t*.48+l*.2+c*.12)*S;i.material.opacity=i.material.opacity*.9+A*.1,i.mesh.instanceMatrix.needsUpdate=!0}function dm(){Zp(),Array.from(document.querySelectorAll("[data-tetra-astrolabe]")).forEach(e=>{if(e.dataset.tetraBound==="true")return;e.dataset.tetraBound="true";const t=e.querySelector("[data-tetra-canvas]");if(!t)return;const n=$p(),r=jp(20260624),s=new Pc,a=new Ft(36,1,.1,18);a.position.set(0,0,5.8);const o=new Kp({canvas:t,antialias:!0,alpha:!0,powerPreference:"high-performance"});o.setClearColor(0,0),o.setPixelRatio(Math.min(window.devicePixelRatio||1,1.55));const l=new wi;s.add(l);const h=window.innerWidth<760?380:1020,p=ss(h,r,Jp,tm,.56,.028,.0025),u=ss(Math.round(h*.38),r,em,im,.4,.036,.0028),m=ss(Math.round(h*.3),r,Qp,nm,.42,.022,.0021);l.add(p.mesh,u.mesh,m.mesh);const v=new Rt,E=new ke(0,0),d=new ke(0,0),f=new ke(0,0),S=new ke(0,0),A=new F,b=new F,w=new F,y=new F,C={position:new ke(0,0),strength:0,speed:0},g={position:new ke(0,0),strength:0,speed:0},T={intro:n?1:0,progress:0};let U=0,R=!1,N=Number.NEGATIVE_INFINITY;const k=()=>{const pe=e.getBoundingClientRect(),Ae=Math.max(1,pe.width),Fe=Math.max(1,pe.height);a.aspect=Ae/Fe,a.updateProjectionMatrix(),o.setSize(Ae,Fe,!1)},W=new ResizeObserver(k);W.observe(e),k();const D=()=>{N=performance.now()},z=os.create({trigger:document.body,start:"top top",end:"bottom bottom",onUpdate:pe=>{T.progress=pe.progress,D()}}),H=bo.to(T,{intro:1,duration:n?0:1.95,ease:"power3.out"}),j=pe=>{if(pe.pointerType==="touch")return;const Ae=e.getBoundingClientRect(),Fe=Pi((pe.clientX-Ae.left)/Ae.width),we=Pi((pe.clientY-Ae.top)/Ae.height),Y=(Fe-.5)*2,oe=-((we-.5)*2),ee=Math.hypot(Y-d.x,oe-d.y);d.x=Y,d.y=oe,A.set(Y,oe,.5).unproject(a),b.copy(A).sub(a.position).normalize(),w.copy(a.position).addScaledVector(b,-a.position.z/b.z),l.updateMatrixWorld(!0),y.copy(w),l.worldToLocal(y),g.position.set(La.clamp(y.x,-1.56,1.56),La.clamp(y.y,-1.14,1.14)),g.strength=1,g.speed=Math.min(1,ee*5.2)},Q=()=>{g.strength=0,g.speed=0};n||(window.addEventListener("pointermove",j,{passive:!0}),window.addEventListener("pointerleave",Q,{passive:!0}),window.addEventListener("blur",Q),window.addEventListener("scroll",D,{passive:!0}),window.addEventListener("wheel",D,{passive:!0}),window.addEventListener("touchmove",D,{passive:!0}));const le=()=>{if(R)return;const pe=performance.now(),Ae=n?1:pe*.001,Fe=!n&&pe-N<180,we=Fe?0:g.strength,Y=Fe?0:g.speed;E.lerp(d,n?1:.045),f.lerp(Fe?S:E,n?1:.22),C.position.lerp(g.position,n?1:.2),C.strength+=(we-C.strength)*(we>0?.075:.18),C.speed+=(Y-C.speed)*(Fe?.24:.12),g.speed*=Fe?.82:.94;const oe=zn(.06,.38,T.progress),ee=zn(.64,.9,T.progress),ye=zn(.07,.2,T.progress),Ce=rm.clone().lerp(sm,ye),be=e.parentElement;be&&(be.style.backgroundColor=`#${Ce.getHexString()}`),l.rotation.x=f.y*.11+Math.sin(Ae*.16)*.035,l.rotation.y=f.x*.13+Ae*(n?0:.034),l.rotation.z=Math.sin(Ae*.11)*.02,l.position.x=.92*(1-oe)-ee*.18,l.position.y=.06*(1-oe)+ee*.08,l.scale.setScalar(1.08-oe*.18+ee*.2),as(p,Ae,T.intro,T.progress,f,C,v,n),as(u,Ae+5,T.intro,Pi(T.progress+.04),f,C,v,n),as(m,Ae+11,T.intro,Pi(T.progress+.08),f,C,v,n),o.render(s,a),e.dataset.ready="true",!n&&(U=window.requestAnimationFrame(le))};U=window.requestAnimationFrame(le),os.refresh();const ve=()=>{R=!0,window.cancelAnimationFrame(U),window.removeEventListener("pointermove",j),window.removeEventListener("pointerleave",Q),window.removeEventListener("blur",Q),window.removeEventListener("scroll",D),window.removeEventListener("wheel",D),window.removeEventListener("touchmove",D),W.disconnect(),z.kill(),H.kill(),o.dispose(),[p.mesh.geometry,p.material,u.mesh.geometry,u.material,m.mesh.geometry,m.material].forEach(pe=>pe.dispose())};document.addEventListener("astro:before-swap",ve,{once:!0})})}export{dm as setupTetraAstrolabe};
